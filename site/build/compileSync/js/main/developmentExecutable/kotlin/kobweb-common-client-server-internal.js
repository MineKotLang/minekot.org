(function (factory) {
  ...
  var split = kotlin_kotlin.$_$.jg;
  var IllegalArgumentException_init_$Create$ = kotlin_kotlin.$_$.p1;
  var startsWith_0 = kotlin_kotlin.$_$.mg;
  var toMutableList = kotlin_kotlin.$_$.y9;
  var endsWith_0 = kotlin_kotlin.$_$.nf;
  ...
  function valueOf(value) {
    switch (value) {
      ...
      default:
        ...
        THROW_IAE('No enum constant com.varabyte.kobweb.navigation.RouteTree.Node.AcceptResult.' + value);
        break;
    }
  }
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            this.node0__1 = removeFirst(this.nodeQueue1__1);
            var nodePath = ArrayList_init_$Create$();
            nodePath.add_utx5q5_k$(this.node0__1);
            var parent = this.node0__1.parent_1;
            while (!(parent == null)) {
              nodePath.add_dl6gt3_k$(0, parent);
              parent = parent.parent_1;
            }

            this.set_state_rjd8d0_k$(2);
            suspendResult = this.$this$sequence_1.yield_3xhcex_k$(nodePath, this);
            ...
            continue $sm;
          case 2:
            this.nodeQueue1__1.addAll_4lagoh_k$(this.node0__1.get_children_4cwbp4_k$());
            this.set_state_rjd8d0_k$(1);
            continue $sm;
          case 3:
  ...
  function valueOf_0(value) {
    switch (value) {
      ...
      default:
        Match_initEntries();
        THROW_IAE('No enum constant com.varabyte.kobweb.navigation.RouteTree.DynamicNode.Match.' + value);
        break;
    }
  }
  ...
  protoOf(Info).equals = function (other) {
    ...
    if (!(this.name_1 === other.name_1))
      return false;
    if (!this.match_1.equals(other.match_1))
      return false;
    return true;
  };
