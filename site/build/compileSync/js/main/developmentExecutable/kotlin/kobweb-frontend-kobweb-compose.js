(function (factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './html-html-core.js', './androidx-compose-runtime-runtime.js', './kotlin-kotlin-stdlib.js', './kobweb-frontend-compose-html-ext.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./html-html-core.js'), require('./androidx-compose-runtime-runtime.js'), require('./kotlin-kotlin-stdlib.js'), require('./kobweb-frontend-compose-html-ext.js'));
  else {
    ...
    globalThis['kobweb-frontend-kobweb-compose'] = factory(typeof globalThis['kobweb-frontend-kobweb-compose'] === 'undefined' ? {} : globalThis['kobweb-frontend-kobweb-compose'], globalThis['html-html-core'], globalThis['androidx-compose-runtime-runtime'], globalThis['kotlin-kotlin-stdlib'], globalThis['kobweb-frontend-compose-html-ext']);
  }
}(function (_, kotlin_org_jetbrains_compose_html_html_core, kotlin_androidx_compose_runtime_runtime, kotlin_kotlin, kotlin_com_varabyte_kobweb_compose_html_ext) {
  'use strict';
  ...
  var columnGap = kotlin_org_jetbrains_compose_html_html_core.$_$.e4;
  var rowGap = kotlin_org_jetbrains_compose_html_html_core.$_$.q5;
  ...
  var Companion_getInstance_5 = kotlin_org_jetbrains_compose_html_html_core.$_$.j;
  var flexDirection = kotlin_org_jetbrains_compose_html_html_core.$_$.i4;
  var Companion_getInstance_6 = kotlin_org_jetbrains_compose_html_html_core.$_$.k;
  var justifyContent = kotlin_org_jetbrains_compose_html_html_core.$_$.w4;
  var flexGrow = kotlin_org_jetbrains_compose_html_html_core.$_$.j4;
  ...
  var backgroundAttachment = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.l;
  var backgroundClip = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.m;
  var backgroundColor = kotlin_org_jetbrains_compose_html_html_core.$_$.p3;
  var backgroundColor_0 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.n;
  var backgroundImage = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.p;
  var backgroundImage_0 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.q;
  ...
  var borderColor = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.x;
  var borderColor_0 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.y;
  ...
  var borderColor_1 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.z;
  var borderColor_2 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.a1;
  var borderStyle = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.d1;
  var borderStyle_0 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.f1;
  var Companion_getInstance_8 = kotlin_org_jetbrains_compose_html_html_core.$_$.l;
  var borderStyle_1 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.c1;
  var borderStyle_2 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.e1;
  var borderWidth = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.h1;
  var borderWidth_0 = kotlin_org_jetbrains_compose_html_html_core.$_$.x3;
  var borderWidth_1 = kotlin_org_jetbrains_compose_html_html_core.$_$.y3;
  var borderWidth_2 = kotlin_org_jetbrains_compose_html_html_core.$_$.w3;
  var border = kotlin_org_jetbrains_compose_html_html_core.$_$.z3;
  var borderLeft = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.b1;
  var borderRadius = kotlin_org_jetbrains_compose_html_html_core.$_$.v3;
  ...
  var opacity = kotlin_org_jetbrains_compose_html_html_core.$_$.j5;
  var color = kotlin_org_jetbrains_compose_html_html_core.$_$.d4;
  ...
  var fontSize = kotlin_org_jetbrains_compose_html_html_core.$_$.l4;
  ...
  var fontFamily = kotlin_org_jetbrains_compose_html_html_core.$_$.k4;
  ...
  var gridRow = kotlin_org_jetbrains_compose_html_html_core.$_$.s4;
  ...
  var marginLeft = kotlin_org_jetbrains_compose_html_html_core.$_$.a5;
  var marginRight = kotlin_org_jetbrains_compose_html_html_core.$_$.b5;
  var marginTop = kotlin_org_jetbrains_compose_html_html_core.$_$.c5;
  var marginBottom = kotlin_org_jetbrains_compose_html_html_core.$_$.z4;
  var padding = kotlin_org_jetbrains_compose_html_html_core.$_$.l5;
  var margin = kotlin_org_jetbrains_compose_html_html_core.$_$.d5;
  var lineHeight = kotlin_org_jetbrains_compose_html_html_core.$_$.y4;
  ...
  var position = kotlin_org_jetbrains_compose_html_html_core.$_$.n5;
  var top = kotlin_org_jetbrains_compose_html_html_core.$_$.t5;
  var left = kotlin_org_jetbrains_compose_html_html_core.$_$.x4;
  var right = kotlin_org_jetbrains_compose_html_html_core.$_$.p5;
  var bottom = kotlin_org_jetbrains_compose_html_html_core.$_$.a4;
  ...
  var minWidth = kotlin_org_jetbrains_compose_html_html_core.$_$.h5;
  var minHeight = kotlin_org_jetbrains_compose_html_html_core.$_$.g5;
  var maxWidth = kotlin_org_jetbrains_compose_html_html_core.$_$.e5;
  ...
  function then(other) {
    return other === Companion_getInstance_14() ? this : new ChainedModifier(this, other);
  }
  ...
  function Box(modifier, contentAlignment, ref, content, $composer, $changed, $default) {
    ...
    if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 1171) === 1170), $dirty & 1)) {
      if (!(($default & 1) === 0)) {
        modifier_0._v = Companion_getInstance_14();
      }
      if (!(($default & 2) === 0)) {
  ...
  function Column(modifier, verticalArrangement, horizontalAlignment, ref, content, $composer, $changed, $default) {
    ...
    if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 9363) === 9362), $dirty & 1)) {
      ...
      var tmp_0;
      if (!(value == null)) {
        tmp_0 = setVariable_0(Companion_getInstance_14(), get_ArrangeSpacedByVar(), value.get_spacing_w0flpi_k$());
      } else {
        tmp_0 = Companion_getInstance_14();
      }
  ...
  function thenIf(_this__u8e3s4, condition, lazyProduce) {
    return _this__u8e3s4.then_mmfvo6_k$(condition ? lazyProduce() : Companion_getInstance_14());
  }
  ...
  function toInRangeInt($this, _this__u8e3s4) {
    ...
    if (!equalsLong(bitwiseAnd(new Long(0, -1), _this__u8e3s4), new Long(0, 0))) {
  ...
  protoOf(RawRgb).inverted_adp911_k$ = function () {
    return Companion_getInstance_15().rgba_3xu3m4_k$(255 - this.get_red_18ix20_k$() | 0, 255 - this.get_green_is36qi_k$() | 0, 255 - this.get_blue_wojj4z_k$() | 0, this.get_alpha_iooth1_k$());
  };
  protoOf(RawRgb).darkened_iwrtmu_k$ = function (byPercent) {
    ...
    return Companion_getInstance_15().rgba_bap9l8_k$(this.get_redf_wotlby_k$() * darkeningMultiplier, this.get_greenf_dxud3g_k$() * darkeningMultiplier, this.get_bluef_ip8ppf_k$() * darkeningMultiplier, this.get_alphaf_b0gxxt_k$());
  };
  protoOf(RawRgb).copy_my5h57_k$ = function (red, green, blue, alpha) {
    return Companion_getInstance_15().rgba_3xu3m4_k$(red, green, blue, alpha);
  };
  protoOf(RawRgb).copyf_olenlb_k$ = function (red, green, blue, alpha) {
    return Companion_getInstance_15().rgba_bap9l8_k$(red, green, blue, alpha);
  };
  ...
  protoOf(RawRgb).toHsl_1tskli_k$ = function () {
    ...
    var hue = tmp;
    return Companion_getInstance_15().hsla_rzsfr4_k$(hue, saturation, lightness, this.get_alphaf_b0gxxt_k$());
  };
  ...
  protoOf(Hsl).copy_egrqb9_k$ = function (hue, saturation, lightness, alpha) {
    return Companion_getInstance_15().hsla_rzsfr4_k$(hue, saturation, lightness, alpha);
  };
  ...
  protoOf(Hsl).toRgb_1tsrpu_k$ = function () {
    ...
    return Companion_getInstance_15().rgba_bap9l8_k$(r + lightnessAdjustment, g + lightnessAdjustment, b + lightnessAdjustment, this.alpha_1);
  };
  ...
  function boxShadow_1(_this__u8e3s4, offsetX, offsetY, blurRadius, spreadRadius, color, inset) {
    ...
    return boxShadow_0(_this__u8e3s4, [Companion_getInstance_9().of_w9d0f3_k$(offsetX, offsetY, blurRadius, spreadRadius, color, inset)]);
  }
  ...
  function boxShadow$lambda($boxShadows) {
    return function ($this$styleModifier) {
      boxShadow($this$styleModifier, Companion_getInstance_9().list_58wzgc_k$($boxShadows.slice()));
      return Unit_getInstance();
    };
  }
  ...
  function fontFamily$lambda$lambda(it) {
    ...
    return '"' + toString_0(trim(isCharSequence(it) ? it : THROW_CCE())) + '"';
  }
      ...
      while (inductionVariable < last) {
        ...
        if (charSequenceLength(element) > 0) {
          ...
          if (!contains(element, ',')) {
            ...
            tmp_0 = Regex_init_$Create$('\\(.+\\)').containsMatchIn_gpzk5u_k$(element);
          }
          tmp = tmp_0;
        } else {
          tmp = false;
        ...
        if (!tmp) {
          ...
          this_0.append_22ad7x_k$('In `Modifier.fontFamily`, a font name shouldn\'t contain a comma, but got "' + element + '".');
          if ($values.length === 1) {
            var tmp_1 = split(element, [',']);
            this_0.append_22ad7x_k$(' Maybe you meant to call `fontFamily(' + joinToString(tmp_1, VOID, VOID, VOID, VOID, VOID, fontFamily$lambda$lambda) + ')`?');
          }
  ...
  function listStyle$lambda($type, $position, $image) {
    return function ($this$styleModifier) {
      listStyle($this$styleModifier, Companion_getInstance_10().of_g8209t_k$($type, $position, $image));
      return Unit_getInstance();
    };
  }
  ...
  function outline$lambda($width, $style, $color) {
    return function ($this$styleModifier) {
      ...
      if (tmp0_safe_receiver == null) {
        ...
        // Inline function 'kotlin.let' call
        tmp_0 = Companion_getInstance_12().of_avfddw_k$(tmp0_safe_receiver);
      }
  ...
  function transition$lambda_0($transitions) {
    return function ($this$styleModifier) {
      transition($this$styleModifier, Companion_getInstance_13().list_jeggvm_k$($transitions.slice()));
      return Unit_getInstance();
    };
  }
  ...
  _.$_$.k = ariaHidden_0;
  _.$_$.l = backgroundColor_1;
  _.$_$.m = borderBottom_0;
  _.$_$.n = borderLeft_0;
  _.$_$.o = borderRadius_0;
  _.$_$.p = borderTop_0;
  _.$_$.q = border_0;
  _.$_$.r = border_1;
  _.$_$.s = bottom_0;
  ...
  _.$_$.l2 = position_0;
  _.$_$.m2 = right_0;
  _.$_$.n2 = scrollBehavior_0;
  _.$_$.o2 = setVariable_0;
  _.$_$.p2 = size;
  _.$_$.q2 = tabIndex;
  _.$_$.r2 = textAlign_0;
  _.$_$.s2 = textDecorationLine_0;
  _.$_$.t2 = top_0;
  _.$_$.u2 = transition_1;
  _.$_$.v2 = transition_0;
  _.$_$.w2 = translateX_0;
  ...
  _.$_$.z2 = whiteSpace_0;
  _.$_$.a3 = width_0;
  _.$_$.b3 = com_varabyte_kobweb_compose_ui_Alignment_Center$stableprop_getter;
  _.$_$.c3 = com_varabyte_kobweb_compose_ui_Alignment_CenterHorizontally$stableprop_getter;
  _.$_$.d3 = com_varabyte_kobweb_compose_ui_Alignment_CenterVertically$stableprop_getter;
  _.$_$.e3 = styleModifier;
  _.$_$.f3 = thenIf_0;
  _.$_$.g3 = toAttrs;
  _.$_$.h3 = toStyles;
  _.$_$.i3 = KobwebComposeStyles;
  _.$_$.j3 = Center_getInstance;
