(function (factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './kotlin-kotlin-stdlib.js', './kobweb-frontend-browser-ext.js', './html-html-core.js', './androidx-compose-runtime-runtime.js', './kobweb-frontend-compose-html-ext.js', './kobweb-common-client-server-internal.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./kotlin-kotlin-stdlib.js'), require('./kobweb-frontend-browser-ext.js'), require('./html-html-core.js'), require('./androidx-compose-runtime-runtime.js'), require('./kobweb-frontend-compose-html-ext.js'), require('./kobweb-common-client-server-internal.js'));
  else {
    ...
    globalThis['kobweb-frontend-kobweb-core'] = factory(typeof globalThis['kobweb-frontend-kobweb-core'] === 'undefined' ? {} : globalThis['kobweb-frontend-kobweb-core'], globalThis['kotlin-kotlin-stdlib'], globalThis['kobweb-frontend-browser-ext'], globalThis['html-html-core'], globalThis['androidx-compose-runtime-runtime'], globalThis['kobweb-frontend-compose-html-ext'], globalThis['kobweb-common-client-server-internal']);
  }
}(function (_, kotlin_kotlin, kotlin_com_varabyte_kobweb_browser_ext, kotlin_org_jetbrains_compose_html_html_core, kotlin_androidx_compose_runtime_runtime, kotlin_com_varabyte_kobweb_compose_html_ext, kotlin_com_varabyte_kobweb_client_server_internal) {
  'use strict';
  ...
  var charArrayOf = kotlin_kotlin.$_$.hc;
  var trimStart = kotlin_kotlin.$_$.jh;
  var Unit_getInstance = kotlin_kotlin.$_$.x4;
  var get_http = kotlin_com_varabyte_kobweb_browser_ext.$_$.b;
  var KMutableProperty0 = kotlin_kotlin.$_$.re;
  ...
  var substringAfterLast = kotlin_kotlin.$_$.ng;
  ...
  var mutableStateOf = kotlin_androidx_compose_runtime_runtime.$_$.y;
  var staticCompositionLocalOf = kotlin_androidx_compose_runtime_runtime.$_$.c1;
  var mutableStateMapOf = kotlin_androidx_compose_runtime_runtime.$_$.x;
  ...
  var A = kotlin_org_jetbrains_compose_html_html_core.$_$.f6;
  var isBlank = kotlin_kotlin.$_$.tf;
  var startsWith = kotlin_kotlin.$_$.mg;
  var endsWith = kotlin_kotlin.$_$.nf;
  var startsWith_0 = kotlin_kotlin.$_$.lg;
  var dropLast = kotlin_kotlin.$_$.kf;
  var charSequenceLength = kotlin_kotlin.$_$.lc;
  var removePrefix = kotlin_kotlin.$_$.cg;
  ...
  var DisposableEffect = kotlin_androidx_compose_runtime_runtime.$_$.j;
  var rememberComposableLambda = kotlin_androidx_compose_runtime_runtime.$_$.b;
  var asReversed = kotlin_kotlin.$_$.q6;
  var substringAfter_0 = kotlin_kotlin.$_$.og;
  var RouteTree = kotlin_com_varabyte_kobweb_client_server_internal.$_$.b;
  var filter = kotlin_kotlin.$_$.ze;
  var map = kotlin_kotlin.$_$.cf;
  var androidx_compose_runtime_ProvidedValue$stableprop_getter = kotlin_androidx_compose_runtime_runtime.$_$.s;
  ...
  var Text = kotlin_org_jetbrains_compose_html_html_core.$_$.d7;
  var composableLambdaInstance = kotlin_androidx_compose_runtime_runtime.$_$.a;
  var toMutableMap = kotlin_kotlin.$_$.aa;
  ...
  var get_vh = kotlin_org_jetbrains_compose_html_html_core.$_$.b6;
  ...
  var Companion_getInstance_1 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.g3;
  var alignItems = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.h;
  var Companion_getInstance_2 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.p3;
  var justifyContent = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.s1;
  //endregion
  ...
  initMetadataForClass(InitRoute, 'InitRoute', VOID, VOID, [Annotation]);
  ...
  initMetadataForClass(Layout, 'Layout', VOID, VOID, [Annotation]);
  ...
  initMetadataForClass(Router$renderActivePage$$inlined$run$2$2$2$1, VOID, VOID, VOID, [DisposableEffectResult]);
  ...
  protoOf(ApiFetcher).delete_2rffrg_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return this.deleteBytes_lcrnnl_k$(apiPath, headers, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).deleteBytes_lcrnnl_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return get_http(this.window_1).deleteBytes_lcrnnl_k$(toResource(this, apiPath), headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).deleteBytes$default_tvmijc_k$ = function (apiPath, headers, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.deleteBytes_lcrnnl_k$(apiPath, headers, redirect, abortController, $completion) : $super.deleteBytes_lcrnnl_k$.call(this, apiPath, headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryDelete_5uhpdc_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return this.tryDeleteBytes_2d4ib5_k$(apiPath, headers, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryDeleteBytes_2d4ib5_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return get_http(this.window_1).tryDeleteBytes_2d4ib5_k$(toResource(this, apiPath), headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryDeleteBytes$default_34v8x2_k$ = function (apiPath, headers, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryDeleteBytes_2d4ib5_k$(apiPath, headers, redirect, abortController, $completion) : $super.tryDeleteBytes_2d4ib5_k$.call(this, apiPath, headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).get_cn1crt_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return this.getBytes_3bkv8q_k$(apiPath, headers, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).getBytes_3bkv8q_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return get_http(this.window_1).getBytes_3bkv8q_k$(toResource(this, apiPath), headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).getBytes$default_9h0awt_k$ = function (apiPath, headers, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.getBytes_3bkv8q_k$(apiPath, headers, redirect, abortController, $completion) : $super.getBytes_3bkv8q_k$.call(this, apiPath, headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryGet_ke4mjp_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return this.tryGetBytes_joc412_k$(apiPath, headers, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryGetBytes_joc412_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return get_http(this.window_1).tryGetBytes_joc412_k$(toResource(this, apiPath), headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryGetBytes$default_2wyhgx_k$ = function (apiPath, headers, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryGetBytes_joc412_k$(apiPath, headers, redirect, abortController, $completion) : $super.tryGetBytes_joc412_k$.call(this, apiPath, headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).head_kwlhpd_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return this.headBytes_259f0s_k$(apiPath, headers, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).headBytes_259f0s_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return get_http(this.window_1).headBytes_259f0s_k$(toResource(this, apiPath), headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).headBytes$default_z8k53h_k$ = function (apiPath, headers, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.headBytes_259f0s_k$(apiPath, headers, redirect, abortController, $completion) : $super.headBytes_259f0s_k$.call(this, apiPath, headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryHead_ehzohx_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return this.tryHeadBytes_1u3cw6_k$(apiPath, headers, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryHeadBytes_1u3cw6_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return get_http(this.window_1).tryHeadBytes_1u3cw6_k$(toResource(this, apiPath), headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryHeadBytes$default_eq4vgx_k$ = function (apiPath, headers, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryHeadBytes_1u3cw6_k$(apiPath, headers, redirect, abortController, $completion) : $super.tryHeadBytes_1u3cw6_k$.call(this, apiPath, headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).options_i36ycf_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return this.optionsBytes_23g9yq_k$(apiPath, headers, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).optionsBytes_23g9yq_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return get_http(this.window_1).optionsBytes_23g9yq_k$(toResource(this, apiPath), headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).optionsBytes$default_ycnvuz_k$ = function (apiPath, headers, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.optionsBytes_23g9yq_k$(apiPath, headers, redirect, abortController, $completion) : $super.optionsBytes_23g9yq_k$.call(this, apiPath, headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryOptions_pg8xyl_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return this.tryOptionsBytes_goahua_k$(apiPath, headers, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryOptionsBytes_goahua_k$ = function (apiPath, headers, redirect, abortController, $completion) {
    return get_http(this.window_1).tryOptionsBytes_goahua_k$(toResource(this, apiPath), headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryOptionsBytes$default_xqmcwn_k$ = function (apiPath, headers, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryOptionsBytes_goahua_k$(apiPath, headers, redirect, abortController, $completion) : $super.tryOptionsBytes_goahua_k$.call(this, apiPath, headers, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).patch_3v7p74_k$ = function (apiPath, headers, body, redirect, abortController, $completion) {
    return this.patchBytes_2wo8wb_k$(apiPath, headers, body, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).patchBytes_2wo8wb_k$ = function (apiPath, headers, body, redirect, abortController, $completion) {
    return get_http(this.window_1).patchBytes_2wo8wb_k$(toResource(this, apiPath), headers, body, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).patchBytes$default_b1o25p_k$ = function (apiPath, headers, body, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    body = body === VOID ? null : body;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.patchBytes_2wo8wb_k$(apiPath, headers, body, redirect, abortController, $completion) : $super.patchBytes_2wo8wb_k$.call(this, apiPath, headers, body, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryPatch_owll70_k$ = function (apiPath, headers, body, redirect, abortController, $completion) {
    return this.tryPatchBytes_4kjttv_k$(apiPath, headers, body, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryPatchBytes_4kjttv_k$ = function (apiPath, headers, body, redirect, abortController, $completion) {
    return get_http(this.window_1).tryPatchBytes_4kjttv_k$(toResource(this, apiPath), headers, body, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryPatchBytes$default_686dx5_k$ = function (apiPath, headers, body, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    body = body === VOID ? null : body;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryPatchBytes_4kjttv_k$(apiPath, headers, body, redirect, abortController, $completion) : $super.tryPatchBytes_4kjttv_k$.call(this, apiPath, headers, body, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).post_sc77oo_k$ = function (apiPath, headers, body, redirect, abortController, $completion) {
    return this.postBytes_u4tah9_k$(apiPath, headers, body, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).postBytes_u4tah9_k$ = function (apiPath, headers, body, redirect, abortController, $completion) {
    return get_http(this.window_1).postBytes_u4tah9_k$(toResource(this, apiPath), headers, body, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).postBytes$default_79knr9_k$ = function (apiPath, headers, body, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    body = body === VOID ? null : body;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.postBytes_u4tah9_k$(apiPath, headers, body, redirect, abortController, $completion) : $super.postBytes_u4tah9_k$.call(this, apiPath, headers, body, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryPost_tmk9za_k$ = function (apiPath, headers, body, redirect, abortController, $completion) {
    return this.tryPostBytes_c7qvwv_k$(apiPath, headers, body, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryPostBytes_c7qvwv_k$ = function (apiPath, headers, body, redirect, abortController, $completion) {
    return get_http(this.window_1).tryPostBytes_c7qvwv_k$(toResource(this, apiPath), headers, body, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryPostBytes$default_4kiluh_k$ = function (apiPath, headers, body, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    body = body === VOID ? null : body;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryPostBytes_c7qvwv_k$(apiPath, headers, body, redirect, abortController, $completion) : $super.tryPostBytes_c7qvwv_k$.call(this, apiPath, headers, body, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).put_5f231l_k$ = function (apiPath, headers, body, redirect, abortController, $completion) {
    return this.putBytes_4f3r6k_k$(apiPath, headers, body, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).putBytes_4f3r6k_k$ = function (apiPath, headers, body, redirect, abortController, $completion) {
    return get_http(this.window_1).putBytes_4f3r6k_k$(toResource(this, apiPath), headers, body, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).putBytes$default_z7erec_k$ = function (apiPath, headers, body, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    body = body === VOID ? null : body;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.putBytes_4f3r6k_k$(apiPath, headers, body, redirect, abortController, $completion) : $super.putBytes_4f3r6k_k$.call(this, apiPath, headers, body, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryPut_ar7nhv_k$ = function (apiPath, headers, body, redirect, abortController, $completion) {
    return this.tryPutBytes_kswhi_k$(apiPath, headers, body, redirect, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryPutBytes_kswhi_k$ = function (apiPath, headers, body, redirect, abortController, $completion) {
    return get_http(this.window_1).tryPutBytes_kswhi_k$(toResource(this, apiPath), headers, body, redirect, abortController, $completion);
  };
  protoOf(ApiFetcher).tryPutBytes$default_b0a4bk_k$ = function (apiPath, headers, body, redirect, abortController, $completion, $super) {
    headers = headers === VOID ? FetchDefaults_getInstance().get_Headers_t2ylqb_k$() : headers;
    body = body === VOID ? null : body;
    redirect = redirect === VOID ? FetchDefaults_getInstance().get_Redirect_rgkds5_k$() : redirect;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryPutBytes_kswhi_k$(apiPath, headers, body, redirect, abortController, $completion) : $super.tryPutBytes_kswhi_k$.call(this, apiPath, headers, body, redirect, abortController, $completion);
  };
  ...
  function getValue_0(_this__u8e3s4, key) {
    return ensureNotNull(_this__u8e3s4.get_rskua5_k$(key));
  }
  ...
  protoOf(InitRoute).equals = function (other) {
    if (!(other instanceof InitRoute))
      return false;
    other instanceof InitRoute || THROW_CCE();
    return true;
  };
  protoOf(InitRoute).hashCode = function () {
    return 0;
  };
  protoOf(InitRoute).toString = function () {
    return '@com.varabyte.kobweb.core.init.InitRoute(' + ')';
  };
  ...
  protoOf(Layout).get_fqn_18j5nq_k$ = function () {
    return this.fqn_1;
  };
  protoOf(Layout).equals = function (other) {
    if (!(other instanceof Layout))
      return false;
    var tmp0_other_with_cast = other instanceof Layout ? other : THROW_CCE();
    if (!(this.fqn_1 === tmp0_other_with_cast.fqn_1))
      return false;
    return true;
  };
  protoOf(Layout).hashCode = function () {
    return imul(getStringHashCode('fqn'), 127) ^ getStringHashCode(this.fqn_1);
  };
  protoOf(Layout).toString = function () {
    return '@com.varabyte.kobweb.core.layout.Layout(' + 'fqn=' + this.fqn_1 + ')';
  };
  ...
  function valueOf(value) {
    switch (value) {
      ...
      default:
        ...
        THROW_IAE('No enum constant com.varabyte.kobweb.navigation.OpenLinkStrategy.' + value);
        break;
    }
  }
  ...
  protoOf(Companion_3).normalizeSlashes_d036g4_k$ = function (url) {
    ...
    if (!startsWith_0(url, '//')) {
      ...
      tmp = splitResult.get_size_woubt6_k$() === 1 ? to('', splitResult.get_c1px32_k$(0)) : to(splitResult.get_c1px32_k$(0) + '://', trimStart(splitResult.get_c1px32_k$(1), charArrayOf([_Char___init__impl__6a9atx(47)])));
    } else {
    ...
    var prefix = _destruct__k2r9zo.component1_7eebsc_k$();
    ...
    return prefix + Regex_init_$Create$('//+').replace_1ix0wf_k$(path, '/') + queryAndFragment;
  };
  ...
  protoOf(Router$renderActivePage$$inlined$run$2$2$2$1).dispose_3nnxhr_k$ = function () {
  };
  ...
  protoOf(Router).tryRoutingTo_z6a3q9_k$ = function (pathQueryAndFragment, updateHistoryMode, openLinkStrategy, routeToErrorPageOnFail) {
  ...
  protoOf(Router).tryRoutingTo$default_6oxk8k_k$ = function (pathQueryAndFragment, updateHistoryMode, openLinkStrategy, routeToErrorPageOnFail, $super) {
    ...
    return $super === VOID ? this.tryRoutingTo_z6a3q9_k$(pathQueryAndFragment, updateHistoryMode, openLinkStrategy, routeToErrorPageOnFail) : $super.tryRoutingTo_z6a3q9_k$.call(this, pathQueryAndFragment, updateHistoryMode, openLinkStrategy, routeToErrorPageOnFail);
  };
  protoOf(Router).navigateTo_5oprea_k$ = function (pathQueryAndFragment, updateHistoryMode, openInternalLinksStrategy, openExternalLinksStrategy) {
    if (!this.tryRoutingTo_z6a3q9_k$(pathQueryAndFragment, updateHistoryMode, openInternalLinksStrategy, false)) {
      var tmp = window;
      var tmp_0 = Companion_getInstance_7().normalizeSlashes_d036g4_k$(pathQueryAndFragment);
      var tmp_1;
  ...
  function ComposableSingletons$RouterKt() {
    ...
    var tmp = this;
    tmp.lambda$215212537__1 = ComposableLambda$invoke$ref_3(composableLambdaInstance(215212537, false, ComposableSingletons$RouterKt$lambda$215212537$lambda));
    var tmp_0 = this;
    tmp_0.lambda$_1582477545_o75blc_1 = ComposableLambda$invoke$ref_4(composableLambdaInstance(-1582477545, false, ComposableSingletons$RouterKt$lambda$_1582477545$lambda_kdntrc));
    var tmp_1 = this;
    tmp_1.lambda$_1070949088_1miekm_1 = ComposableLambda$invoke$ref_5(composableLambdaInstance(-1070949088, false, ComposableSingletons$RouterKt$lambda$_1070949088$lambda_malff6));
    var tmp_2 = this;
    tmp_2.lambda$_149473399_dxnuon_1 = ComposableLambda$invoke$ref_6(composableLambdaInstance(-149473399, false, ComposableSingletons$RouterKt$lambda$_149473399$lambda_vw12th));
  }
  ...
  function valueOf_0(value) {
    switch (value) {
      ...
      default:
        ...
        THROW_IAE('No enum constant com.varabyte.kobweb.navigation.UpdateHistoryMode.' + value);
        break;
    }
  }
  ...
  _.$_$.c = initKobweb;
  _.$_$.d = KobwebApp;
  _.$_$.e = com_varabyte_kobweb_core_PageContext$stableprop_getter;
  _.$_$.f = rememberPageContext;
  _.$_$.g = Anchor;
  _.$_$.h = Router;
  _.$_$.i = com_varabyte_kobweb_navigation_Router$stableprop_getter;
  _.$_$.j = remove;
  _.$_$.k = UpdateHistoryMode_REPLACE_getInstance;
  _.$_$.l = AppGlobals_getInstance;
