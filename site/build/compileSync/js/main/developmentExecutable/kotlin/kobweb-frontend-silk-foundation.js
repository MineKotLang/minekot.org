(function (factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './androidx-compose-runtime-runtime.js', './kotlin-kotlin-stdlib.js', './kotlin_org_jetbrains_kotlin_kotlin_dom_api_compat.js', './html-html-core.js', './kobweb-frontend-compose-html-ext.js', './kobweb-frontend-browser-ext.js', './kobweb-frontend-kobweb-compose.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./androidx-compose-runtime-runtime.js'), require('./kotlin-kotlin-stdlib.js'), require('./kotlin_org_jetbrains_kotlin_kotlin_dom_api_compat.js'), require('./html-html-core.js'), require('./kobweb-frontend-compose-html-ext.js'), require('./kobweb-frontend-browser-ext.js'), require('./kobweb-frontend-kobweb-compose.js'));
  else {
    ...
    globalThis['kobweb-frontend-silk-foundation'] = factory(typeof globalThis['kobweb-frontend-silk-foundation'] === 'undefined' ? {} : globalThis['kobweb-frontend-silk-foundation'], globalThis['androidx-compose-runtime-runtime'], globalThis['kotlin-kotlin-stdlib'], kotlin_org_jetbrains_kotlin_kotlin_dom_api_compat, globalThis['html-html-core'], globalThis['kobweb-frontend-compose-html-ext'], globalThis['kobweb-frontend-browser-ext'], globalThis['kobweb-frontend-kobweb-compose']);
  }
}(function (_, kotlin_androidx_compose_runtime_runtime, kotlin_kotlin, kotlin_org_jetbrains_kotlin_kotlin_dom_api_compat, kotlin_org_jetbrains_compose_html_html_core, kotlin_com_varabyte_kobweb_compose_html_ext, kotlin_com_varabyte_kobweb_browser_ext, kotlin_com_varabyte_kobweb_kobweb_compose) {
  'use strict';
  ...
  var stringPresentation = kotlin_org_jetbrains_compose_html_html_core.$_$.x6;
  var CSSKeyframesRuleDeclaration = kotlin_org_jetbrains_compose_html_html_core.$_$.r2;
  ...
  var CSSStyledRuleDeclaration = kotlin_org_jetbrains_compose_html_html_core.$_$.v2;
  ...
  var minus = kotlin_kotlin.$_$.h8;
  var to = kotlin_kotlin.$_$.di;
  var scope = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.h2;
  ...
  var flatMap = kotlin_kotlin.$_$.je;
  ...
  var trimIndent = kotlin_kotlin.$_$.dg;
  var initMetadataForCompanion = kotlin_kotlin.$_$.lc;
  var Companion_getInstance_0 = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.q3;
  ...
  var listOf_0 = kotlin_kotlin.$_$.c8;
  ...
  var trimMargin = kotlin_kotlin.$_$.eg;
  var media = kotlin_org_jetbrains_compose_html_html_core.$_$.f5;
  var isNotEmpty = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.r1;
  ...
  var com_varabyte_kobweb_compose_css_ComparableStyleScope$stableprop_getter = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.l1;
  ...
  var Percentage = kotlin_org_jetbrains_compose_html_html_core.$_$.p2;
  var Combine = kotlin_org_jetbrains_compose_html_html_core.$_$.o2;
  var StyleScopeBuilder = kotlin_org_jetbrains_compose_html_html_core.$_$.i3;
  var CSSKeyframeRuleDeclaration = kotlin_org_jetbrains_compose_html_html_core.$_$.q2;
  var Companion_getInstance_2 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.l3;
  var Raw = kotlin_org_jetbrains_compose_html_html_core.$_$.t2;
  var get_lastIndex = kotlin_kotlin.$_$.w7;
  var MediaFeature = kotlin_org_jetbrains_compose_html_html_core.$_$.s2;
  var GenericTag_0 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.z2;
  var CSSMediaRuleDeclaration = kotlin_org_jetbrains_compose_html_html_core.$_$.u2;
  ...
  initMetadataForClass(ColorModeAware$$inlined$cache$2$1, VOID, VOID, VOID, [DisposableEffectResult]);
  initMetadataForClass(CustomStyle$$inlined$run$2$2$1, VOID, VOID, VOID, [DisposableEffectResult]);
  ...
  initMetadataForClass(ComposableSingletons$BreakpointConditionsKt$lambda$321895361$3$$inlined$cache$2$1, VOID, VOID, VOID, [DisposableEffectResult]);
  ...
  function ColorModeAware(element, $composer, $changed, $default) {
    ...
    if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 3) === 2), $dirty & 1)) {
      ...
      var colorMode = Companion_getInstance_11().get_current_2iudd5_k$($composer_0, 6);
      var tmp0 = $composer_0;
  ...
  protoOf(ColorModeAware$$inlined$cache$2$1).dispose_3nnxhr_k$ = function () {
  ...
  function SilkFoundationStyles(initSilk_0, $composer, $changed, $default) {
    ...
    if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 3) === 2), $dirty & 1)) {
      ...
      $composer_0.startMovableGroup_clfloq_k$(691485527, Unit_getInstance());
      var tmp0 = $composer_0;
      // Inline function 'androidx.compose.runtime.cache' call
  ...
  function CustomStyle(styleSheet, $composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(205150148);
    var $dirty = $changed;
    if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.changedInstance_s1wkiy_k$(styleSheet) ? 4 : 2);
    if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 3) === 2), $dirty & 1)) {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.updateScope_t8jcf_k$(CustomStyle$lambda_0(styleSheet, $changed));
    }
  }
  ...
  function customStringPresentation(_this__u8e3s4, baseIndent, indent, delimiter) {
    ...
    if (isInterface(cssRuleDeclaration, CSSStyledRuleDeclaration)) {
      ...
      strings.add_utx5q5_k$(baseIndent + indent + style.cssText);
    } else {
  ...
  protoOf(CustomStyle$$inlined$run$2$2$1).dispose_3nnxhr_k$ = function () {
  ...
  function CustomStyle$lambda($styleSheet) {
    return function ($this$GenericTag, $composer, $changed) {
      var $composer_0 = $composer;
      var cssRules = $styleSheet.get_cssRules_jdoznh_k$();
      var tmp = cssRules.get_size_woubt6_k$();
      // Inline function 'androidx.compose.runtime.cache' call
      var invalid = !!($composer_0.changedInstance_s1wkiy_k$($this$GenericTag) | $composer_0.changedInstance_s1wkiy_k$(cssRules));
      // Inline function 'kotlin.let' call
  ...
  function initSilk(additionalInit) {
    ...
    var finalCssLayers = getLayersWithCompat(Companion_getInstance_5().get_current_jwi6j4_k$(), registeredCssLayers);
    ...
    $l$block: {
      ...
      if (!Companion_getInstance_5().get_current_jwi6j4_k$().equals(ColorModeStrategy_BOTH_getInstance())) {
  ...
  protoOf(SilkStylesheetInstance).registerStylesAndKeyframesInto_i9rw0p_k$ = function (siteStyleSheet) {
    ...
    while (_iterator__ex2g4s_0.hasNext_bitz1p_k$()) {
      var element_0 = _iterator__ex2g4s_0.next_20eer_k$();
      element_0.addStylesInto_v6y74w_k$(siteStyleSheet);
    }
    // Inline function 'kotlin.collections.forEach' call
    // Inline function 'kotlin.collections.iterator' call
    var _iterator__ex2g4s_1 = this.keyframes_1.get_entries_p20ztl_k$().iterator_jk1svi_k$();
    while (_iterator__ex2g4s_1.hasNext_bitz1p_k$()) {
      var element_1 = _iterator__ex2g4s_1.next_20eer_k$();
      // Inline function 'kotlin.collections.component1' call
      var name = element_1.get_key_18j28a_k$();
      // Inline function 'kotlin.collections.component2' call
      var build = element_1.get_value_j01efc_k$();
      // Inline function 'kotlin.apply' call
  ...
  function Companion_0() {
    ...
    if (!get_CSSScopeSupport()) {
      ...
      $l$block: {
        ...
        while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
          var element = _iterator__ex2g4s.next_20eer_k$();
          if (element.get_name_woqyms_k$() === Companion_getInstance_5().urlStrategy_1) {
            tmp$ret$1 = element;
            break $l$block;
          }
        }
  ...
  function valueOf(value) {
    switch (value) {
      ...
      default:
        ColorModeStrategy_initEntries();
        THROW_IAE('No enum constant com.varabyte.kobweb.silk.style.ColorModeStrategy.' + value);
        break;
    }
  }
  ...
  function CssStyle$Restricted$Base$_init_$lambda_wfn4zd($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0.startReplaceGroup_5hh8aj_k$(906014673);
    var tmp0 = Companion_getInstance_0();
    $composer_0.endReplaceGroup_ek144q_k$();
    return tmp0;
  }
  ...
  function CssStyle$Restricted$Base$_init_$lambda_wfn4zd_1($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0.startReplaceGroup_5hh8aj_k$(293000442);
    var tmp0 = Companion_getInstance_0();
    $composer_0.endReplaceGroup_ek144q_k$();
    return tmp0;
  }
  ...
  function CssStyle$Restricted$_init_$lambda_tv1gbe($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0.startReplaceGroup_5hh8aj_k$(1908519190);
    var tmp0 = Companion_getInstance_0();
    $composer_0.endReplaceGroup_ek144q_k$();
    return tmp0;
  }
  ...
  function CssStyle$_init_$lambda_598xul($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0.startReplaceGroup_5hh8aj_k$(-1204013637);
    var tmp0 = Companion_getInstance_0();
    $composer_0.endReplaceGroup_ek144q_k$();
    return tmp0;
  }
  function CssStyle$addStyles$lambda($styles) {
    return function ($this$style) {
      // Inline function 'kotlin.collections.forEach' call
      var _iterator__ex2g4s = $styles.get_properties_zhllqc_k$().iterator_jk1svi_k$();
      while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
        var element = _iterator__ex2g4s.next_20eer_k$();
        $this$style.property_wcrait_k$(element.get_name_woqyms_k$(), element.get_value_j01efc_k$());
      }
      // Inline function 'kotlin.collections.forEach' call
      var _iterator__ex2g4s_0 = $styles.get_variables_75f0zy_k$().iterator_jk1svi_k$();
      while (_iterator__ex2g4s_0.hasNext_bitz1p_k$()) {
        var element_0 = _iterator__ex2g4s_0.next_20eer_k$();
        $this$style.variable_kvosx8_k$(element_0.get_name_woqyms_k$(), element_0.get_value_j01efc_k$());
      }
      return Unit_getInstance();
    };
  }
  function withSuffixedSelectorName$suffixedWith(_this__u8e3s4, colorMode) {
    var tmp0_safe_receiver = Companion_getInstance_1().tryCreate_50aflp_k$(removePrefix(_this__u8e3s4, '.'));
  ...
  function CssStyle$addStylesInto$lambda_0($classNames, $styleSheet, $layer, this$0) {
    return function (name, styles) {
      ...
      if (isNotEmpty(styles)) {
        ...
        var tmp_0 = suffixedStyleLayer(Companion_getInstance_5().get_current_jwi6j4_k$(), $layer);
  ...
  function CssStyle$addStylesInto$lambda$lambda_2($layer, this$0, $cssRule, $styles) {
    return function ($this$mediaOrInPlace) {
      var tmp = suffixedStyleLayer(Companion_getInstance_5().get_current_jwi6j4_k$(), $layer);
  ...
  protoOf(CssStyle).addStylesInto_avvx4p_k$ = function (selector, styleSheet, layer) {
    ...
    var tmp0_safe_receiver = lightModifiers.get_wei43m_k$(Companion_getInstance_9().get_BaseKey_nx9788_k$());
    var tmp_0 = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.get_modifier_t1pq5c_k$();
    var tmp1_safe_receiver = darkModifiers.get_wei43m_k$(Companion_getInstance_9().get_BaseKey_nx9788_k$());
    var tmp2_safe_receiver = tmp.from_e5pdcm_k$(tmp_0, tmp1_safe_receiver == null ? null : tmp1_safe_receiver.get_modifier_t1pq5c_k$());
    if (tmp2_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      if (get_useScope(Companion_getInstance_5().get_current_jwi6j4_k$())) {
        withColorModeScope(this, styleSheet, selector, tmp2_safe_receiver, CssStyle$addStylesInto$lambda(layer, this));
      }
      if (get_useSuffix(Companion_getInstance_5().get_current_jwi6j4_k$())) {
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      var element = _iterator__ex2g4s.next_20eer_k$();
      if (!element.equals(Companion_getInstance_9().get_BaseKey_nx9788_k$())) {
        destination.add_utx5q5_k$(element);
      }
    }
  ...
  protoOf(SimpleCssStyle).addStylesInto_v6y74w_k$ = function (styleSheet) {
    this.addStylesInto_avvx4p_k$(this.selector_1, styleSheet, this.layer_1);
  };
  function CssKind() {
  }
  ...
  protoOf(ImmutableCssStyle).toModifier_7iov47_k$ = function ($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0.startReplaceGroup_5hh8aj_k$(-1357650385);
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      var element = _iterator__ex2g4s.next_20eer_k$();
      if (!isSuffixedWith(new CssIdent(element), Companion_getInstance_11().get_current_2iudd5_k$($composer_0, 6).get_opposite_ywslzk_k$())) {
        destination.add_utx5q5_k$(element);
      }
    }
    $composer_0.endReplaceGroup_ek144q_k$();
  ...
  function toModifier(_this__u8e3s4, variants, $composer, $changed) {
    ...
    var tmp_0;
    if (tmp0_safe_receiver == null) {
      $composer_0.startReplaceGroup_5hh8aj_k$(-303432124);
      $composer_0.endReplaceGroup_ek144q_k$();
      tmp_0 = null;
    } else {
      $composer_0.startReplaceGroup_5hh8aj_k$(-2087998115);
  ...
  function ExtendingCssStyle$_init_$lambda_m2ritn($extraModifier, $baseStyle) {
    return function ($composer, $changed) {
      ...
      var tmp0 = $extraModifier($composer_0, 0).then_mmfvo6_k$(toModifier_0($baseStyle, $composer_0, 0));
      $composer_0.endReplaceGroup_ek144q_k$();
      return tmp0;
    };
  }
  ...
  function _toModifier(_this__u8e3s4, $composer, $changed) {
    ...
    var tmp;
    if (tmp0_safe_receiver == null) {
      $composer_0.startReplaceGroup_5hh8aj_k$(4742520);
      $composer_0.endReplaceGroup_ek144q_k$();
      tmp = null;
    } else {
      $composer_0.startReplaceGroup_5hh8aj_k$(554342313);
  ...
  protoOf(Key).equals = function (other) {
    ...
    if (!(other instanceof Key))
      return false;
    if (!(this.mediaQuery_1 == other.mediaQuery_1))
      return false;
  ...
  function assertNoAttributes(_this__u8e3s4, selectorName, lazyExtraContext) {
    ...
    if (!(_this__u8e3s4.mediaQuery_1 == null)) {
      this_0.append_22ad7x_k$('@media ' + toString(_this__u8e3s4.mediaQuery_1) + ' { ');
    }
  ...
  function Keyframes$usesColorMode$delegate$lambda(this$0) {
    return function () {
      return !Companion_getInstance_10().isColorModeAgnostic_fn4jgj_k$(this$0.init_1);
    };
  }
  ...
  function valueOf_0(value) {
    switch (value) {
      ...
      case 'XXL':
        return Breakpoint_XXL_getInstance();
      default:
        Breakpoint_initEntries();
        THROW_IAE('No enum constant com.varabyte.kobweb.silk.style.breakpoint.Breakpoint.' + value);
        break;
    }
  }
  ...
  function SilkBreakpointDisplayStyles($composer, $changed) {
    ...
    if ($composer_0.shouldExecute_4fplh_k$(!($changed === 0), $changed & 1)) {
      GenericTag_0('style', null, ComposableSingletons$BreakpointConditionsKt_getInstance().lambda$321895361__1, $composer_0, 390, 2);
    } else {
      $composer_0.skipToGroupEnd_lh3zi2_k$();
    }
    var tmp0_safe_receiver = $composer_0.endRestartGroup_yxpjv9_k$();
  ...
  protoOf(ComposableSingletons$BreakpointConditionsKt$lambda$321895361$3$$inlined$cache$2$1).dispose_3nnxhr_k$ = function () {
    var tmp0_safe_receiver = this.$cssStylesheet_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
  ...
  function get_displayIfAtLeastClass(_this__u8e3s4) {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    return 'silk-display-if-at-least-' + _this__u8e3s4.get_name_woqyms_k$().toLowerCase();
  }
  function get_displayUntilClass(_this__u8e3s4) {
    // Inline function 'kotlin.text.lowercase' call
    // Inline function 'kotlin.js.asDynamic' call
    return 'silk-display-until-' + _this__u8e3s4.get_name_woqyms_k$().toLowerCase();
  }
  ...
  protoOf(BreakpointValues).get_xxl_18is59_k$ = function () {
    return this.xxl_1;
  };
  ...
  protoOf(BreakpointValues).component5_7eebs8_k$ = function () {
    return this.xxl_1;
  };
  protoOf(BreakpointValues).copy_uims53_k$ = function (sm, md, lg, xl, xxl) {
    return new BreakpointValues(sm, md, lg, xl, xxl);
  };
  protoOf(BreakpointValues).copy$default_efbhz1_k$ = function (sm, md, lg, xl, xxl, $super) {
    sm = sm === VOID ? this.sm_1 : sm;
    md = md === VOID ? this.md_1 : md;
    lg = lg === VOID ? this.lg_1 : lg;
    xl = xl === VOID ? this.xl_1 : xl;
    xxl = xxl === VOID ? this.xxl_1 : xxl;
    return $super === VOID ? this.copy_uims53_k$(sm, md, lg, xl, xxl) : $super.copy_uims53_k$.call(this, sm, md, lg, xl, xxl);
  };
  protoOf(BreakpointValues).toString = function () {
    return 'BreakpointValues(sm=' + toString(this.sm_1) + ', md=' + toString(this.md_1) + ', lg=' + toString(this.lg_1) + ', xl=' + toString(this.xl_1) + ', xxl=' + toString(this.xxl_1) + ')';
  };
  protoOf(BreakpointValues).hashCode = function () {
    ...
    result = imul(result, 31) + hashCode(this.xxl_1) | 0;
    return result;
  };
  protoOf(BreakpointValues).equals = function (other) {
    ...
    if (!(other instanceof BreakpointValues))
      return false;
    if (!equals(this.sm_1, other.sm_1))
      return false;
    ...
    if (!equals(this.xl_1, other.xl_1))
      return false;
    if (!equals(this.xxl_1, other.xxl_1))
      return false;
    return true;
  };
  ...
  function valueOf_1(value) {
    switch (value) {
      ...
      default:
        ...
        THROW_IAE('No enum constant com.varabyte.kobweb.silk.style.layer.SilkLayer.' + value);
        break;
    }
  }
  ...
  function not(_this__u8e3s4, params) {
    return Companion_getInstance_6().OfFunctionalPseudoClass_dg5wg3_k$('not', params.slice());
  }
  ...
  protoOf(ImmutableSilkTheme).get_palette_vetkex_k$ = function ($composer, $changed) {
    var $composer_0 = $composer;
    return this.palettes_1.get_4bsmki_k$(Companion_getInstance_11().get_current_2iudd5_k$($composer_0, 6));
  };
  ...
  function MutableSilkTheme() {
    ...
    this.breakpoints_1 = BreakpointSizes(get_cssRem(30), get_cssRem(48), get_cssRem(62), get_cssRem(80), get_cssRem(96));
  }
  ...
  function modifyStyleBase$lambda$lambda($this_modifyStyle, $init) {
    return function () {
      var tmp0 = new CssStyleBaseScope($this_modifyStyle.get_colorMode_trbg8z_k$());
      // Inline function 'kotlin.let' call
      return $init(tmp0);
    };
  }
  ...
  function toValue(_this__u8e3s4) {
    ...
    switch (_this__u8e3s4.get_ordinal_ip24qg_k$()) {
      ...
      case 4:
        ...
        break;
      case 5:
        tmp = get_SilkTheme().get_breakpoints_k65pzb_k$().get_xxl_18is59_k$();
        break;
      default:
        noWhenBranchMatchedException();
        break;
  ...
  function valueOf_2(value) {
    switch (value) {
      ...
      default:
        ColorMode_initEntries();
        THROW_IAE('No enum constant com.varabyte.kobweb.silk.theme.colors.ColorMode.' + value);
        break;
    }
  }
  ...
  _.$_$.y = base_1;
  _.$_$.z = base;
  _.$_$.a1 = com_varabyte_kobweb_silk_style_CssStyle$stableprop_getter;
  _.$_$.b1 = com_varabyte_kobweb_silk_style_CssStyleVariant$stableprop_getter;
  _.$_$.c1 = com_varabyte_kobweb_silk_style_CssStyle_Restricted_Base$stableprop_getter;
  _.$_$.d1 = toAttrs_0;
  _.$_$.e1 = toModifier_1;
  _.$_$.f1 = toModifier;
  _.$_$.g1 = toModifier_0;
  _.$_$.h1 = get_useScope;
  _.$_$.i1 = ColorGroup;
  _.$_$.j1 = MutablePalette;
  _.$_$.k1 = com_varabyte_kobweb_silk_theme_colors_palette_MutablePalette_ColorGroup$stableprop_getter;
  _.$_$.l1 = com_varabyte_kobweb_silk_theme_colors_palette_MutablePalette_ColorGroup_EntryDelegate$stableprop_getter;
  _.$_$.m1 = toPalette;
  _.$_$.n1 = get_entries_2;
  _.$_$.o1 = get_cssClass;
  _.$_$.p1 = isSuffixedWith;
  _.$_$.q1 = suffixedWith;
  _.$_$.r1 = withColorModeSuffixRemoved;
  _.$_$.s1 = clip;
  _.$_$.t1 = get_SilkTheme;
  _.$_$.u1 = modifyStyleBase;
  _.$_$.v1 = ColorModeAware;
