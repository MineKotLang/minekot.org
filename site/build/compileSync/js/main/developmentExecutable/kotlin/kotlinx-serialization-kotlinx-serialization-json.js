(function (factory) {
  ...
  var toDouble = kotlin_kotlin.$_$.wg;
  ...
  var toLongOrNull = kotlin_kotlin.$_$.zg;
  var toULongOrNull = kotlin_kotlin.$_$.eh;
  ...
  var toDoubleOrNull = kotlin_kotlin.$_$.vg;
  var toBooleanStrictOrNull = kotlin_kotlin.$_$.tg;
  ...
  var DeepRecursiveFunction = kotlin_kotlin.$_$.uh;
  var invoke = kotlin_kotlin.$_$.bj;
  var CoroutineImpl = kotlin_kotlin.$_$.wa;
  var DeepRecursiveScope = kotlin_kotlin.$_$.vh;
  ...
  var findPolymorphicSerializer_0 = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.j2;
  ...
  var convertToByte = kotlin_kotlin.$_$.kb;
  var equalsLong = kotlin_kotlin.$_$.ob;
  var convertToShort = kotlin_kotlin.$_$.mb;
  ...
  var toUInt = kotlin_kotlin.$_$.dh;
  var _UInt___get_data__impl__f0vqqw = kotlin_kotlin.$_$.d3;
  var toULong = kotlin_kotlin.$_$.fh;
  var toUByte = kotlin_kotlin.$_$.ch;
  var _UByte___get_data__impl__jof9qr = kotlin_kotlin.$_$.u2;
  var toUShort = kotlin_kotlin.$_$.gh;
  ...
  var numberToChar = kotlin_kotlin.$_$.vd;
  ...
  var ClosedRange = kotlin_kotlin.$_$.ee;
  var contains_0 = kotlin_kotlin.$_$.je;
  var single = kotlin_kotlin.$_$.ig;
  ...
  var indexOf = kotlin_kotlin.$_$.sf;
  var last_0 = kotlin_kotlin.$_$.h8;
  var removeLast = kotlin_kotlin.$_$.c9;
  var lastIndexOf = kotlin_kotlin.$_$.ag;
  ...
  var chunked = kotlin_kotlin.$_$.gf;
  var HashMap_init_$Create$ = kotlin_kotlin.$_$.m;
  //endregion
  //region block: pre-declaration
  initMetadataForClass(JsonBuilder, 'JsonBuilder');
  initMetadataForClass(Json_0, 'Json', VOID, VOID, [StringFormat]);
  initMetadataForObject(Default, 'Default', VOID, Json_0);
  initMetadataForClass(JsonImpl, 'JsonImpl', VOID, Json_0);
  ...
  initMetadataForClass(JsonPrimitive_1, 'JsonPrimitive', VOID, JsonElement, VOID, VOID, VOID, makeAssociatedObjectMapES5([SerializableWith, JsonPrimitiveSerializer_getInstance]));
  ...
  initMetadataForObject(JsonNull, 'JsonNull', VOID, JsonPrimitive_1, [JsonPrimitive_1, SerializerFactory], VOID, VOID, makeAssociatedObjectMapES5([SerializableWith, JsonNullSerializer_getInstance]));
  ...
  function Json(from, builderAction) {
  ...
  function Default() {
    ...
    Json_0.call(this, new JsonConfiguration(), EmptySerializersModule());
  }
  ...
  protoOf(Json_0).get_configuration_uqypjh_k$ = function () {
    return this.configuration_1;
  };
  protoOf(Json_0).get_serializersModule_piitvg_k$ = function () {
    return this.serializersModule_1;
  };
  protoOf(Json_0).get__schemaCache_7cqc2k_k$ = function () {
    return this._schemaCache_1;
  };
  protoOf(Json_0).encodeToString_k0apqx_k$ = function (serializer, value) {
  ...
  protoOf(Json_0).decodeFromString_jwu9sq_k$ = function (deserializer, string) {
  ...
  protoOf(Json_0).encodeToJsonElement_w5lo4o_k$ = function (serializer, value) {
    return writeJson(this, value, serializer);
  };
  protoOf(Json_0).decodeFromJsonElement_tsogwj_k$ = function (deserializer, element) {
    return readJson(this, element, deserializer);
  };
  protoOf(Json_0).parseToJsonElement_rqvr2k_k$ = function (string) {
  ...
  protoOf(AbstractJsonTreeDecoder).getPrimitiveValue_cue515_k$ = function (tag, descriptor) {
    ...
    // Inline function 'kotlinx.serialization.json.internal.cast' call
    var serialName = descriptor.get_serialName_u2rqhk_k$();
    if (!(tmp2 instanceof JsonPrimitive_1)) {
      var tmp = getKClass(JsonPrimitive_1).get_simpleName_r6f8py_k$();
      var tmp_0 = getKClassFromExpression(tmp2).get_simpleName_r6f8py_k$();
      var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
      throw JsonDecodingException_1(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + serialName + ' at element: ' + tmp$ret$0, toString(tmp2));
    }
    return tmp2;
  };
  protoOf(AbstractJsonTreeDecoder).decodeTaggedEnum_lbnta6_k$ = function (tag, enumDescriptor) {
    ...
    if (!(tmp2 instanceof JsonPrimitive_1)) {
      ...
      var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
      throw JsonDecodingException_1(-1, 'Expected ' + tmp_0 + ', but had ' + tmp_1 + ' as the serialized body of ' + serialName + ' at element: ' + tmp$ret$0, toString(tmp2));
    }
  ...
  protoOf(AbstractJsonTreeDecoder).decodeTaggedInline_tuyvom_k$ = function (tag, inlineDescriptor) {
    ...
    if (get_isUnsignedNumber(inlineDescriptor)) {
      ...
      if (!(tmp2 instanceof JsonPrimitive_1)) {
        ...
        var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
        throw JsonDecodingException_1(-1, 'Expected ' + tmp_1 + ', but had ' + tmp_2 + ' as the serialized body of ' + serialName + ' at element: ' + tmp$ret$0, toString(tmp2));
      }
      ...
      if (tmp) {
        ...
        $l$block_2: {
          ...
          if (equals(elementDescriptor.get_kind_wop7ml_k$(), ENUM_getInstance())) {
            ...
            var tmp0_safe_receiver = tmp_4 instanceof JsonPrimitive_1 ? tmp_4 : null;
