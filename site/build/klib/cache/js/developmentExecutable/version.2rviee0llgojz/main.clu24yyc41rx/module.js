(function (factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './androidx-compose-runtime-runtime.js', './kotlin-kotlin-stdlib.js', './kobweb-frontend-kobweb-core.js', './kobweb-frontend-silk-foundation.js', './html-internal-html-core-runtime.js', './kobweb-frontend-silk-widgets.js', './kobweb-frontend-silk-widgets-kobweb.js', './kobweb-common-kobwebx-frontmatter.js', './kobweb-frontend-kobwebx-markdown.js', './html-html-core.js', './kobweb-frontend-compose-html-ext.js', './kobweb-frontend-kobweb-silk.js', './kotlinx-coroutines-core.js', './kobweb-frontend-kobweb-compose.js'], factory);
    ...
    globalThis['org.example.app:site'] = factory(typeof globalThis['org.example.app:site'] === 'undefined' ? {} : globalThis['org.example.app:site'], globalThis['androidx-compose-runtime-runtime'], globalThis['kotlin-kotlin-stdlib'], globalThis['kobweb-frontend-kobweb-core'], globalThis['kobweb-frontend-silk-foundation'], globalThis['html-internal-html-core-runtime'], globalThis['kobweb-frontend-silk-widgets'], globalThis['kobweb-frontend-silk-widgets-kobweb'], globalThis['kobweb-common-kobwebx-frontmatter'], globalThis['kobweb-frontend-kobwebx-markdown'], globalThis['html-html-core'], globalThis['kobweb-frontend-compose-html-ext'], globalThis['kobweb-frontend-kobweb-silk'], globalThis['kotlinx-coroutines-core'], globalThis['kobweb-frontend-kobweb-compose']);
  }
  ...
  var removeSuffix = kotlin_kotlin.$_$.jf;
  ...
  var Companion_getInstance_2 = kotlin_com_varabyte_kobweb_silk_foundation.$_$.e2;
  ...
  var Companion_getInstance_6 = kotlin_com_varabyte_kobweb_silk_foundation.$_$.d2;
  ...
  var set_color = kotlin_com_varabyte_kobweb_silk_widgets.$_$.m;
  var set_border = kotlin_com_varabyte_kobweb_silk_widgets.$_$.k;
  ...
  var Companion_getInstance_8 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.s3;
  ...
  var toAttrs_0 = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.g3;
  var Svg = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.x2;
  ...
  var Center_getInstance = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.o3;
  var com_varabyte_kobweb_compose_ui_Alignment_Center$stableprop_getter = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.b3;
  ...
  var Stop = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.w2;
  var RadialGradient = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.v2;
  ...
  function main() {
    _init_properties_main_kt__ykjpl3();
    AppGlobals_getInstance().initialize_8ufbf0_k$(mapOf(to('title', 'MineKot')));
  ...
  function ComposableSingletons$MainKt$lambda$_1396482527$lambda$lambda_v3zxsi($pageMethod, $pageCtx) {
    return function ($this$_org_example_app_components_layouts_PageLayout, $composer, $changed) {
      ...
      var tmp;
      if (($changed & 6) === 0) {
        $dirty = $dirty | ($composer_0.changed_ga7h3f_k$($this$_org_example_app_components_layouts_PageLayout) ? 4 : 2);
        tmp = Unit_getInstance();
      }
      var tmp_0;
      if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 19) === 18), $dirty & 1)) {
  ...
  function ComposableSingletons$MainKt() {
    ...
    var tmp_8 = this;
    tmp_8.lambda$_1100462627_miwg91__1 = ComposableLambda$invoke$ref_11(composableLambdaInstance(-1100462627, false, ComposableSingletons$MainKt$lambda$_1100462627$lambda_ty3cjn));
    var tmp_9 = this;
  ...
  protoOf(ComposableSingletons$MainKt).get_lambda$_1396482527_7sjdov_k$ = function () {
    return this.lambda$_1396482527_ixh6ed_1;
  };
  protoOf(ComposableSingletons$MainKt).get_lambda$_521244896_j0aauv_k$ = function () {
    return this.lambda$_521244896_pfstq1__1;
  };
  protoOf(ComposableSingletons$MainKt).get_lambda$_1474002729_2u5tw0_k$ = function () {
    return this.lambda$_1474002729_480lcs_1;
  };
  protoOf(ComposableSingletons$MainKt).get_lambda$19909720_rcn1i2_k$ = function () {
    return this.lambda$19909720__1;
  };
  protoOf(ComposableSingletons$MainKt).get_lambda$1513822169_2l49vl_k$ = function () {
    return this.lambda$1513822169__1;
  };
  protoOf(ComposableSingletons$MainKt).get_lambda$_1287232678_u1bq9i_k$ = function () {
    return this.lambda$_1287232678_47fjca_1;
  };
  protoOf(ComposableSingletons$MainKt).get_lambda$206679771_bi4znc_k$ = function () {
    return this.lambda$206679771__1;
  };
  protoOf(ComposableSingletons$MainKt).get_lambda$1700592220_yi6uh3_k$ = function () {
    return this.lambda$1700592220__1;
  };
  protoOf(ComposableSingletons$MainKt).get_lambda$_1100462627_emj4hb_k$ = function () {
    return this.lambda$_1100462627_miwg91__1;
  };
  ...
  function main$lambda(ctx) {
    ...
    tmp.registerLayout_p67cby_k$('org.example.app.components.layouts.MarkdownLayout', 'org.example.app.components.layouts.PageLayout', main$lambda$lambda, ComposableSingletons$MainKt_getInstance().lambda$1498945258__1);
    ctx.get_router_j3zccy_k$().registerLayout$default_45q2ls_k$('org.example.app.components.layouts.PageLayout', VOID, VOID, ComposableSingletons$MainKt_getInstance().lambda$_1396482527_ixh6ed_1);
    ...
    tmp_0.register_7fiee8_k$('/about', 'org.example.app.components.layouts.MarkdownLayout', main$lambda$lambda_0, ComposableSingletons$MainKt_getInstance().lambda$_1474002729_480lcs_1);
    ctx.get_router_j3zccy_k$().register$default_cpqgbm_k$('/addons/', VOID, VOID, ComposableSingletons$MainKt_getInstance().lambda$19909720__1);
  ...
  function AboutPage($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-120633928);
    if ($composer_0.shouldExecute_4fplh_k$(!($changed === 0), $changed & 1)) {
      ...
      H1(tmp$ret$3, ComposableSingletons$AboutKt_getInstance().lambda$_1984207531_qlhgoe_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$_863562666_uzcpfu_1, $composer_0, 48, 1);
      ...
      H2(tmp$ret$7, ComposableSingletons$AboutKt_getInstance().lambda$1144063446__1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$_407715891_xu2qio_1, $composer_0, 48, 1);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      H3(tmp$ret$11, ComposableSingletons$AboutKt_getInstance().lambda$_22632873_yhy4b5__1, $composer_0, 54, 0);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      H4(tmp$ret$15, ComposableSingletons$AboutKt_getInstance().lambda$_1189329192_fj0t1b_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$_1574412210_nrd903__1, $composer_0, 48, 1);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      H4(tmp$ret$19, ComposableSingletons$AboutKt_getInstance().lambda$63265231__1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$1553858767__1, $composer_0, 48, 1);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      H4(tmp$ret$23, ComposableSingletons$AboutKt_getInstance().lambda$_1103431088_lgm9ch_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$387162448__1, $composer_0, 48, 1);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      H4(tmp$ret$27, ComposableSingletons$AboutKt_getInstance().lambda$2024839889__1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$_779533871_zdhyl6__1, $composer_0, 48, 1);
      Ul(null, ComposableSingletons$AboutKt_getInstance().lambda$167972387__1, $composer_0, 48, 1);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      H4(tmp$ret$31, ComposableSingletons$AboutKt_getInstance().lambda$858143570__1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$_1946230190_bqf0wj_1, $composer_0, 48, 1);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      H4(tmp$ret$35, ComposableSingletons$AboutKt_getInstance().lambda$_308552749_9uhk9h_1, $composer_0, 54, 0);
      Ul(null, ComposableSingletons$AboutKt_getInstance().lambda$_1239975334_qh15is_1, $composer_0, 48, 1);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      H3(tmp$ret$39, ComposableSingletons$AboutKt_getInstance().lambda$271963534__1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$1182040787__1, $composer_0, 48, 1);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      H4(tmp$ret$43, ComposableSingletons$AboutKt_getInstance().lambda$_1475249068_jwtmjw_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$15344468__1, $composer_0, 48, 1);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      H4(tmp$ret$47, ComposableSingletons$AboutKt_getInstance().lambda$1653021909__1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$_1151351851_6a7x3j_1, $composer_0, 48, 1);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      H4(tmp$ret$51, ComposableSingletons$AboutKt_getInstance().lambda$486325590__1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$_1149041355_9uj263__1, $composer_0, 48, 1);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      H2(tmp$ret$55, ComposableSingletons$AboutKt_getInstance().lambda$480661837__1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$1979229622__1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$812533303__1, $composer_0, 48, 1);
      Pre(null, ComposableSingletons$AboutKt_getInstance().lambda$893371593__1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$_354163016_mcajft_1, $composer_0, 48, 1);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      H2(tmp$ret$59, ComposableSingletons$AboutKt_getInstance().lambda$_686034482_n25vbz_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$_1520859335_bj8fmd_1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$1607411642__1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$440715323__1, $composer_0, 48, 1);
      Pre(null, ComposableSingletons$AboutKt_getInstance().lambda$83959680__1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$_725980996_n4zqhd_1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$_1892677315_d2nnov_1, $composer_0, 48, 1);
      Pre(null, ComposableSingletons$AboutKt_getInstance().lambda$_1082736639_ffw91x_1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$1235593662__1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().lambda$1338078420__1, $composer_0, 48, 1);
    } else {
      $composer_0.skipToGroupEnd_lh3zi2_k$();
    }
    var tmp0_safe_receiver = $composer_0.endRestartGroup_yxpjv9_k$();
  ...
  function ComposableSingletons$AboutKt$lambda$_1574412210$lambda_f9ktwf($this$P, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$_1156226033_4fyj6d_1, $composer_0, 48, 1);
    Text('.', $composer_0, 6);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$AboutKt$lambda$_1253383182$lambda_ndryw2($this$Li, $composer, $changed) {
    var $composer_0 = $composer;
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$_1547501133_5ajeky_1, $composer_0, 48, 1);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
  ...
  function ComposableSingletons$AboutKt$lambda$_1888593381$lambda_xuoq4a($this$Li, $composer, $changed) {
    var $composer_0 = $composer;
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$_1068102756_c38uuu_1, $composer_0, 48, 1);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it = $composer_0.rememberedValue_4dg93v_k$();
    var tmp;
  ...
  function ComposableSingletons$AboutKt$lambda$_806785094$lambda_2h44rh($this$Li, $composer, $changed) {
    var $composer_0 = $composer;
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$13705531__1, $composer_0, 48, 1);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it = $composer_0.rememberedValue_4dg93v_k$();
    var tmp;
  ...
  function ComposableSingletons$AboutKt$lambda$167972387$lambda($this$Ul, $composer, $changed) {
    var $composer_0 = $composer;
    Li(null, ComposableSingletons$AboutKt_getInstance().lambda$_1253383182_6ruut0__1, $composer_0, 48, 1);
    Li(null, ComposableSingletons$AboutKt_getInstance().lambda$_1888593381_pb12do_1, $composer_0, 48, 1);
  ...
  function ComposableSingletons$AboutKt$lambda$_1946230190$lambda_iwqddx($this$P, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$_1528044013_v1tr8c_1, $composer_0, 48, 1);
    Text(' under this folder additionally tagged with ', $composer_0, 6);
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$690882826__1, $composer_0, 48, 1);
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$_132798645_1zihy7__1, $composer_0, 48, 1);
  ...
  function ComposableSingletons$AboutKt$lambda$_1363077015$lambda_jagisb($this$Li, $composer, $changed) {
    var $composer_0 = $composer;
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$_542586390_mnwfja_1, $composer_0, 48, 1);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it = $composer_0.rememberedValue_4dg93v_k$();
    var tmp;
  ...
  function ComposableSingletons$AboutKt$lambda$_1914722222$lambda_tsijaw($this$Li, $composer, $changed) {
    var $composer_0 = $composer;
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$597753235__1, $composer_0, 48, 1);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it = $composer_0.rememberedValue_4dg93v_k$();
    var tmp;
  ...
  function ComposableSingletons$AboutKt$lambda$_1239975334$lambda_x9tc56($this$Ul, $composer, $changed) {
    var $composer_0 = $composer;
    Li(null, ComposableSingletons$AboutKt_getInstance().lambda$_1363077015_99yj9p_1, $composer_0, 48, 1);
  ...
  function ComposableSingletons$AboutKt$lambda$15344468$lambda($this$P, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$433530645__1, $composer_0, 48, 1);
  ...
  function ComposableSingletons$AboutKt$lambda$_1151351851$lambda_2dmb1f($this$P, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$_733165674_rhj9jq_1, $composer_0, 48, 1);
  ...
  function ComposableSingletons$AboutKt$lambda$_1149041355$lambda_l9kgq5($this$P, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$_1070171756_5dcyq3__1, $composer_0, 48, 1);
    Text(' blocks to define them (similar to declaring ', $composer_0, 6);
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$_1002916483_w0k9dq_1, $composer_0, 48, 1);
    Text(' style blocks). Once defined, call ', $composer_0, 6);
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$_767238308_nxuq8k_1, $composer_0, 48, 1);
  ...
  function ComposableSingletons$AboutKt$lambda$1979229622$lambda($this$P, $composer, $changed) {
    ...
    Em(null, ComposableSingletons$AboutKt_getInstance().lambda$_1098683078_u0n6mm_1, $composer_0, 48, 1);
  ...
  function ComposableSingletons$AboutKt$lambda$1607411642$lambda($this$P, $composer, $changed) {
    ...
    Em(null, ComposableSingletons$AboutKt_getInstance().lambda$_1470501058_iwquax_1, $composer_0, 48, 1);
    Text(' and ', $composer_0, 6);
    Em(null, ComposableSingletons$AboutKt_getInstance().lambda$332658151__1, $composer_0, 48, 1);
    Text('. You can ', $composer_0, 6);
    Link('https://kobweb.varabyte.com/docs/concepts/foundation/exporting#static-layout-vs-full-stack-sites', null, null, null, null, null, null, ComposableSingletons$AboutKt_getInstance().lambda$_569598676_4bih1z_1, $composer_0, 12582918, 126);
    Text('.', $composer_0, 6);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$AboutKt$lambda$_725980996$lambda_idspo9($this$P, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().lambda$_647111397_ituq4p_1, $composer_0, 48, 1);
    Text(' folder.', $composer_0, 6);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$AboutKt$lambda$1338078420$lambda($this$P, $composer, $changed) {
    var $composer_0 = $composer;
    Text('You can ', $composer_0, 6);
    Link('https://bitspittle.dev/blog/2022/static-deploy', null, null, null, null, null, null, ComposableSingletons$AboutKt_getInstance().lambda$_838931898_jqz7ql_1, $composer_0, 12582918, 126);
  ...
  protoOf(ComposableSingletons$AboutKt).get_lambda$_863562666_ygddzg_k$ = function () {
    return this.lambda$_863562666_uzcpfu_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$1144063446_pfvypk_k$ = function () {
    return this.lambda$1144063446__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_407715891_75bkea_k$ = function () {
    return this.lambda$_407715891_xu2qio_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_22632873_s35oil_k$ = function () {
    return this.lambda$_22632873_yhy4b5__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1189329192_pgje45_k$ = function () {
    return this.lambda$_1189329192_fj0t1b_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1156226033_39dee7_k$ = function () {
    return this.lambda$_1156226033_4fyj6d_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1574412210_7wkkgv_k$ = function () {
    return this.lambda$_1574412210_nrd903__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$63265231_i9r0xx_k$ = function () {
    return this.lambda$63265231__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$1553858767_g50l1e_k$ = function () {
    return this.lambda$1553858767__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1103431088_nmuscl_k$ = function () {
    return this.lambda$_1103431088_lgm9ch_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$387162448_a4doms_k$ = function () {
    return this.lambda$387162448__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$2024839889_myksyi_k$ = function () {
    return this.lambda$2024839889__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_779533871_cand2g_k$ = function () {
    return this.lambda$_779533871_zdhyl6__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1547501133_yk0mti_k$ = function () {
    return this.lambda$_1547501133_5ajeky_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1253383182_qf8wlc_k$ = function () {
    return this.lambda$_1253383182_6ruut0__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1068102756_b5sd7a_k$ = function () {
    return this.lambda$_1068102756_c38uuu_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1888593381_wgydk8_k$ = function () {
    return this.lambda$_1888593381_pb12do_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$13705531_eexzjs_k$ = function () {
    return this.lambda$13705531__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_806785094_byr093_k$ = function () {
    return this.lambda$_806785094_pwulq3__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$167972387_u2uu6x_k$ = function () {
    return this.lambda$167972387__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$858143570_2z7g1c_k$ = function () {
    return this.lambda$858143570__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1528044013_9eptow_k$ = function () {
    return this.lambda$_1528044013_v1tr8c_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$690882826_osmtgu_k$ = function () {
    return this.lambda$690882826__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_132798645_mepn8d_k$ = function () {
    return this.lambda$_132798645_1zihy7__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1946230190_folgcn_k$ = function () {
    return this.lambda$_1946230190_bqf0wj_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_308552749_qe94d3_k$ = function () {
    return this.lambda$_308552749_9uhk9h_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_542586390_y1dn6k_k$ = function () {
    return this.lambda$_542586390_mnwfja_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1363077015_xlsj89_k$ = function () {
    return this.lambda$_1363077015_99yj9p_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$597753235_pqz0y1_k$ = function () {
    return this.lambda$597753235__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1914722222_96egru_k$ = function () {
    return this.lambda$_1914722222_upfatm_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1239975334_k2ebvs_k$ = function () {
    return this.lambda$_1239975334_qh15is_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$271963534_9o8n2b_k$ = function () {
    return this.lambda$271963534__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$1182040787_65skgt_k$ = function () {
    return this.lambda$1182040787__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1475249068_oup5uo_k$ = function () {
    return this.lambda$_1475249068_jwtmjw_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$433530645_66w2wg_k$ = function () {
    return this.lambda$433530645__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$15344468_rouzga_k$ = function () {
    return this.lambda$15344468__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$1653021909_fik9e3_k$ = function () {
    return this.lambda$1653021909__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_733165674_ih4yxg_k$ = function () {
    return this.lambda$_733165674_rhj9jq_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1151351851_5fju91_k$ = function () {
    return this.lambda$_1151351851_6a7x3j_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$486325590_94jvc1_k$ = function () {
    return this.lambda$486325590__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1070171756_k0p40n_k$ = function () {
    return this.lambda$_1070171756_5dcyq3__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1002916483_xr5ugm_k$ = function () {
    return this.lambda$_1002916483_w0k9dq_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_767238308_we5ifm_k$ = function () {
    return this.lambda$_767238308_nxuq8k_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1149041355_cvqmi7_k$ = function () {
    return this.lambda$_1149041355_9uj263__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$480661837_h5egcu_k$ = function () {
    return this.lambda$480661837__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1098683078_5azvb6_k$ = function () {
    return this.lambda$_1098683078_u0n6mm_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$1979229622_nctyue_k$ = function () {
    return this.lambda$1979229622__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$812533303_9nwvpr_k$ = function () {
    return this.lambda$812533303__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$1311557770_ds9hgm_k$ = function () {
    return this.lambda$1311557770__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$893371593_m5zkcr_k$ = function () {
    return this.lambda$893371593__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_354163016_4tiv11_k$ = function () {
    return this.lambda$_354163016_mcajft_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_686034482_s7nx5v_k$ = function () {
    return this.lambda$_686034482_n25vbz_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1520859335_pujxr3_k$ = function () {
    return this.lambda$_1520859335_bj8fmd_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1470501058_e65kpp_k$ = function () {
    return this.lambda$_1470501058_iwquax_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$332658151_1u1c1v_k$ = function () {
    return this.lambda$332658151__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_569598676_ulls4r_k$ = function () {
    return this.lambda$_569598676_4bih1z_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$1607411642_m4zlcb_k$ = function () {
    return this.lambda$1607411642__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$440715323_ft9b0g_k$ = function () {
    return this.lambda$440715323__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1766050047_ljpf9q_k$ = function () {
    return this.lambda$_1766050047_dtbrsy_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$83959680_4s7v9_k$ = function () {
    return this.lambda$83959680__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_647111397_dq23pn_k$ = function () {
    return this.lambda$_647111397_ituq4p_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_725980996_l1urin_k$ = function () {
    return this.lambda$_725980996_n4zqhd_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1892677315_uzvqf9_k$ = function () {
    return this.lambda$_1892677315_d2nnov_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$1362220930_dmopmr_k$ = function () {
    return this.lambda$1362220930__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_1082736639_vs025b_k$ = function () {
    return this.lambda$_1082736639_ffw91x_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$1235593662_yt8u7v_k$ = function () {
    return this.lambda$1235593662__1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$_838931898_lcd0nl_k$ = function () {
    return this.lambda$_838931898_jqz7ql_1;
  };
  protoOf(ComposableSingletons$AboutKt).get_lambda$1338078420_31uc5j_k$ = function () {
    return this.lambda$1338078420__1;
  };
  ...
  function set_listenersRegistered(_set____db54di) {
    listenersRegistered = _set____db54di;
  }
  function get_listenersRegistered() {
  ...
  function readStoredTheme() {
    var tmp;
    try {
      var stored = window.localStorage.getItem('minekot.theme');
      switch (stored) {
        case 'light':
        case 'dark':
          tmp = stored;
  ...
  function registerThemeSyncListeners() {
    var tmp = window;
    tmp.addEventListener('storage', registerThemeSyncListeners$lambda);
    var tmp_0 = window;
    tmp_0.addEventListener('focus', registerThemeSyncListeners$lambda_0);
    var tmp_1 = window;
    tmp_1.addEventListener('pageshow', registerThemeSyncListeners$lambda_1);
    var tmp_2 = document;
    tmp_2.addEventListener('visibilitychange', registerThemeSyncListeners$lambda_2);
  }
  function ensureThemeBootstrapped() {
  ...
  function AppEntry(content, $composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-215587818);
    var $dirty = $changed;
    if (($changed & 6) === 0)
  ...
  function registerThemeSyncListeners$lambda(event) {
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = event.key;
    var changedKey = (!(tmp == null) ? typeof tmp === 'string' : false) ? tmp : null;
    if (changedKey === 'minekot.theme') {
      syncThemeFromStorage();
    }
    return Unit_getInstance();
  }
  function registerThemeSyncListeners$lambda_0(it) {
    syncThemeFromStorage();
    return Unit_getInstance();
  }
  function registerThemeSyncListeners$lambda_1(it) {
    syncThemeFromStorage();
    return Unit_getInstance();
  }
  function registerThemeSyncListeners$lambda_2(it) {
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = document.visibilityState;
    var state = (!(tmp == null) ? typeof tmp === 'string' : false) ? tmp : null;
    if (state === 'visible') {
      syncThemeFromStorage();
    }
    return Unit_getInstance();
    ...
    $sm: do
      try {
        ...
        if (tmp === 0) {
          ...
          var theme = this.$colorMode_1.get_name_woqyms_k$().toLowerCase();
          var tmp0_safe_receiver = document.documentElement;
          if (tmp0_safe_receiver == null)
            null;
          else {
  ...
  function AppEntry$lambda($content) {
    return function ($composer, $changed) {
      ...
      var tmp;
      if ($composer_0.shouldExecute_4fplh_k$(!(($changed & 3) === 2), $changed & 1)) {
        var colorMode = Companion_getInstance_2().get_current_2iudd5_k$($composer_0, 6);
        // Inline function 'androidx.compose.runtime.cache' call
  ...
  function initSiteStyles$lambda$lambda() {
    _init_properties_AppStyles_kt__9fg0zz();
    return scrollBehavior(Companion_getInstance_3(), Companion_getInstance_5().get_Smooth_4edjo7_k$());
  }
  ...
  function Brand(primary, accent) {
    primary = primary === VOID ? Companion_getInstance_7().rgb_6orfmz_k$(3965935) : primary;
    accent = accent === VOID ? Companion_getInstance_7().rgb_6orfmz_k$(15981403) : accent;
  ...
  function SitePalettes() {
    ...
    this.light_1 = new SitePalette(Companion_getInstance_7().rgb_6orfmz_k$(16054010), Colors_getInstance().get_LightGray_i1h2r4_k$(), new Brand(Companion_getInstance_7().rgb_6orfmz_k$(3965935), Companion_getInstance_7().rgb_6orfmz_k$(16562691)));
    this.dark_1 = new SitePalette(Companion_getInstance_7().rgb_6orfmz_k$(2303027), Colors_getInstance().get_LightGray_i1h2r4_k$().inverted_adp911_k$(), new Brand(Companion_getInstance_7().rgb_6orfmz_k$(13346551), Companion_getInstance_7().rgb_6orfmz_k$(13346551)));
  }
  ...
  function initTheme(ctx) {
    ...
    var storedTheme = tmp;
    ctx.get_config_c0698r_k$().set_initialColorMode_lmyh2d_k$(storedTheme === 'light' ? ColorMode_LIGHT_getInstance() : ColorMode_DARK_getInstance());
    set_background(ctx.get_theme_iz24rk_k$().get_palettes_f7ft27_k$().get_light_iuogdp_k$(), Companion_getInstance_7().rgb_6orfmz_k$(15791359));
    set_color(ctx.get_theme_iz24rk_k$().get_palettes_f7ft27_k$().get_light_iuogdp_k$(), Colors_getInstance().get_Black_i7mvue_k$());
    set_background(ctx.get_theme_iz24rk_k$().get_palettes_f7ft27_k$().get_dark_wokkvz_k$(), Companion_getInstance_7().rgb_6orfmz_k$(1315873));
    set_color(ctx.get_theme_iz24rk_k$().get_palettes_f7ft27_k$().get_dark_wokkvz_k$(), Companion_getInstance_7().rgb_6orfmz_k$(13489908));
    set_border(ctx.get_theme_iz24rk_k$().get_palettes_f7ft27_k$().get_dark_wokkvz_k$(), Companion_getInstance_7().rgba_vsmmr0_k$(133, 139, 166, 0.18));
    get_link(ctx.get_theme_iz24rk_k$().get_palettes_f7ft27_k$().get_dark_wokkvz_k$()).set_default_r70t7m_k$(Companion_getInstance_7().rgb_6orfmz_k$(9024762));
    get_link(ctx.get_theme_iz24rk_k$().get_palettes_f7ft27_k$().get_dark_wokkvz_k$()).set_visited_wsyhe3_k$(Companion_getInstance_7().rgb_6orfmz_k$(9024762));
  }
  function org_example_app_SitePalette_Brand$stableprop_getter() {
    return org_example_app_SitePalette_Brand$stable;
  }
  function org_example_app_SitePalette$stableprop_getter() {
    return org_example_app_SitePalette$stable;
  }
  function org_example_app_SitePalettes$stableprop_getter() {
    return org_example_app_SitePalettes$stable;
  }
  ...
  function MarkdownLayout(content, $composer, $changed) {
    _init_properties_MarkdownLayout_kt__1k3pk7();
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-584464285);
    var $dirty = $changed;
    if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.changedInstance_s1wkiy_k$(content) ? 4 : 2);
    if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 3) === 2), $dirty & 1)) {
  ...
  function MarkdownStyle$lambda$lambda_3() {
    _init_properties_MarkdownLayout_kt__1k3pk7();
    return margin(fontWeight_0(fontSize(Companion_getInstance_3(), get_cssRem(1.2)), Companion_getInstance_8().get_Bolder_3mclb9_k$()), get_cssRem(1), VOID, get_cssRem(0.5));
  }
  function MarkdownStyle$lambda$lambda_4() {
    _init_properties_MarkdownLayout_kt__1k3pk7();
    return overflowWrap(fillMaxWidth(Companion_getInstance_3()), Companion_getInstance_9().get_BreakWord_a9p49s_k$());
  }
  ...
  function MarkdownStyle$lambda$lambda_6($this_CssStyle) {
    return function () {
      return fontWeight_0(color(Companion_getInstance_3(), get_color(toPalette($this_CssStyle.get_colorMode_trbg8z_k$())).toRgb_1tsrpu_k$().copyf$default_6pu18v_k$(VOID, VOID, VOID, 0.8)), Companion_getInstance_8().get_Bolder_3mclb9_k$());
    };
  }
  ...
  function MarkdownStyle$lambda$lambda$lambda($this$overflow) {
    _init_properties_MarkdownLayout_kt__1k3pk7();
    $this$overflow.x_7tere2_k$(Companion_getInstance_10().get_Auto_wnyn88_k$());
    return Unit_getInstance();
  }
  ...
  function SvgCobweb(modifier, $composer, $changed) {
    _init_properties_PageLayout_kt__pf69s7();
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-1405805726);
    var $dirty = $changed;
    if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.changed_ga7h3f_k$(modifier) ? 4 : 2);
    if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 3) === 2), $dirty & 1)) {
      var color = toSitePalette(Companion_getInstance_2().get_current_2iudd5_k$($composer_0, 6)).get_cobweb_bzyxwn_k$();
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.updateScope_t8jcf_k$(SvgCobweb$lambda_1(modifier, $changed));
    }
  }
  ...
  function PageLayout(ctx, content, $composer, $changed) {
    _init_properties_PageLayout_kt__pf69s7();
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-87651282);
    var $dirty = $changed;
    if (($changed & 6) === 0)
    ...
    if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 19) === 18), $dirty & 1)) {
      ...
      var tmp_1 = minHeight(fillMaxWidth(Companion_getInstance_3()), get_vh(100));
      // Inline function 'androidx.compose.runtime.cache' call
      var this_1 = $composer_0;
      // Inline function 'kotlin.let' call
      var it_0 = this_1.rememberedValue_4dg93v_k$();
  ...
  function SvgCobweb$lambda$lambda_0($cobwebFadeOutId) {
    return function ($this$Path) {
      ...
      $this$Path.fill_r8yrtt_k$($cobwebFadeOutId);
      return Unit_getInstance();
    };
  }
  ...
  protoOf(PageLayout$slambda).doResume_5yljmg_k$ = function () {
    ...
    $sm: do
      try {
        ...
        if (tmp === 0) {
          this.set_exceptionState_fex74n_k$(1);
          document.title = 'Kobweb - ' + this.$data_1.title_1;
          return Unit_getInstance();
        } else if (tmp === 1) {
          throw this.get_exception_x0n6w6_k$();
        }
  ...
  function PageLayout$lambda_0($content) {
    return function ($this$Box, $composer, $changed) {
      ...
      if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 19) === 18), $dirty & 1)) {
        ...
        Div(toAttrs_0(gridRow(fillMaxWidth(Companion_getInstance_3()), 2)), ComposableSingletons$PageLayoutKt_getInstance().lambda$_2066276813_jxkx8p_1, $composer_0, 48, 0);
        tmp_0 = Unit_getInstance();
      } else {
        $composer_0.skipToGroupEnd_lh3zi2_k$();
        tmp_0 = Unit_getInstance();
  ...
  function SiteScaffold(activePath, footerText, content, $composer, $changed, $default) {
    ...
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(885527611);
    var $dirty = $changed;
    if (($changed & 6) === 0)
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.updateScope_t8jcf_k$(SiteScaffold$lambda_1(activePath, footerText_0, content, $changed, $default));
    }
  }
  ...
  function MainNavLink(path, label, isActive, $composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-463094245);
    var $dirty = $changed;
    if (($changed & 6) === 0)
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.updateScope_t8jcf_k$(MainNavLink$lambda_1(path, label, isActive, $changed));
    }
  }
  function NavHeader(activePath, $composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-1920103014);
    var $dirty = $changed;
    if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.changed_ga7h3f_k$(activePath) ? 4 : 2);
    if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 3) === 2), $dirty & 1)) {
      var ctx = rememberPageContext($composer_0, 0);
      var colorMode$delegate = Companion_getInstance_2().get_currentState_dmzs7c_k$($composer_0, 6);
      // Inline function 'androidx.compose.runtime.cache' call
      var this_0 = $composer_0;
      // Inline function 'kotlin.let' call
      var it = this_0.rememberedValue_4dg93v_k$();
  ...
  function ComposableSingletons$NavHeaderKt$lambda$988319814$lambda($this$A, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Span(tmp$ret$3, ComposableSingletons$NavHeaderKt_getInstance().lambda$_2085856988_pufwqz_1, $composer_0, 54, 0);
    Span(null, ComposableSingletons$NavHeaderKt_getInstance().lambda$_1644122597_jaet3__1, $composer_0, 48, 1);
    return Unit_getInstance();
  }
  function ComposableSingletons$NavHeaderKt$lambda$988319814$lambda$lambda($this$Span) {
    $this$Span.classes_ayghm2_k$(['brand-mark']);
    return Unit_getInstance();
  }
  ...
  protoOf(ComposableSingletons$NavHeaderKt).get_lambda$_1644122597_pst6mt_k$ = function () {
    return this.lambda$_1644122597_jaet3__1;
  };
  protoOf(ComposableSingletons$NavHeaderKt).get_lambda$988319814_p44bf4_k$ = function () {
    return this.lambda$988319814__1;
  };
  ...
  function MainNavLink$lambda($isActive) {
    return function ($this$A) {
      var tmp;
      if ($isActive) {
        $this$A.attr_w68641_k$('aria-current', 'page');
        tmp = Unit_getInstance();
      }
      $this$A.attr_w68641_k$('data-theme-nav', '');
      return Unit_getInstance();
    };
  }
  ...
  function NavHeader$lambda_1($this$Div) {
    $this$Div.classes_ayghm2_k$(['topbar']);
    return Unit_getInstance();
  }
  function NavHeader$lambda$lambda($this$Div) {
    $this$Div.classes_ayghm2_k$(['container', 'topbar-inner']);
    return Unit_getInstance();
  }
  function NavHeader$lambda$lambda$lambda($this$A) {
    $this$A.classes_ayghm2_k$(['brand']);
    return Unit_getInstance();
  }
  function NavHeader$lambda$lambda$lambda_0($this$Nav) {
    $this$Nav.classes_ayghm2_k$(['nav']);
    $this$Nav.attr_w68641_k$('aria-label', 'Main');
    $this$Nav.style_xwwy6r_k$(NavHeader$lambda$lambda$lambda$lambda);
    return Unit_getInstance();
  }
  ...
  function NavHeader$lambda$lambda$lambda_2($colorMode$delegate) {
    return function ($this$Button) {
      $this$Button.classes_ayghm2_k$(['btn']);
      $this$Button.attr_w68641_k$('data-theme-toggle', '');
      $this$Button.onClick_q9cds6_k$(NavHeader$lambda$lambda$lambda$lambda_0($colorMode$delegate));
      return Unit_getInstance();
    };
  }
  function NavHeader$lambda$lambda$lambda_3($colorMode$delegate) {
    return function ($this$Button, $composer, $changed) {
      var $composer_0 = $composer;
      Text(NavHeader$lambda($colorMode$delegate).get_isDark_evw91l_k$() ? '\u2600\uFE0F' : '\uD83C\uDF19', $composer_0, 0);
      return Unit_getInstance();
    };
  }
  ...
  function NavHeader$lambda$lambda_0($colorMode$delegate, $activePath) {
    return function ($this$Div, $composer, $changed) {
      ...
      var tmp_0 = tmp;
      var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
      A('/', tmp$ret$3, ComposableSingletons$NavHeaderKt_getInstance().lambda$988319814__1, $composer_0, 438, 0);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      var it_0 = $composer_0.rememberedValue_4dg93v_k$();
      var tmp_1;
  ...
  function IconButton(onClick, content, $composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-1471203443);
    var $dirty = $changed;
    if (($changed & 6) === 0)
    ...
    if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 19) === 18), $dirty & 1)) {
      ...
      // Inline function 'kotlin.run' call
      var dispatchReceiver = rememberComposableLambda(669229949, true, IconButton$lambda_0(content), $composer_0, 54);
      // Inline function 'androidx.compose.runtime.remember' call
      var $composer_1 = $composer_0;
      sourceInformationMarkerStart($composer_1, 1157296644, 'CC(remember)P(1):Composables.kt#9igjgp');
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      sourceInformationMarkerEnd($composer_1);
      Button_0(tmp_1, tmp_2, tmp_3, null, false, null, null, null, null, tmp0_0, $composer_0, 805306368 | com_varabyte_kobweb_silk_style_CssStyleVariant$stableprop_getter() << 6, 504);
    } else {
      $composer_0.skipToGroupEnd_lh3zi2_k$();
    }
    var tmp0_safe_receiver = $composer_0.endRestartGroup_yxpjv9_k$();
  ...
  function DocEntry(id, type, title, typeLabel, description, syntaxCode, exampleCode) {
    ...
    this.type_1 = type;
    this.title_1 = title;
    this.typeLabel_1 = typeLabel;
    this.description_1 = description;
    this.syntaxCode_1 = syntaxCode;
    this.exampleCode_1 = exampleCode;
  }
  protoOf(DocEntry).get_id_kntnx8_k$ = function () {
    return this.id_1;
  };
  protoOf(DocEntry).get_type_wovaf7_k$ = function () {
    return this.type_1;
  };
  protoOf(DocEntry).get_title_iz32un_k$ = function () {
    return this.title_1;
  };
  protoOf(DocEntry).get_typeLabel_gsybe9_k$ = function () {
    return this.typeLabel_1;
  };
  protoOf(DocEntry).get_description_emjre5_k$ = function () {
    return this.description_1;
  };
  protoOf(DocEntry).get_syntaxCode_dbtptz_k$ = function () {
    return this.syntaxCode_1;
  };
  protoOf(DocEntry).get_exampleCode_i8u1v6_k$ = function () {
    return this.exampleCode_1;
  };
  protoOf(DocEntry).component1_7eebsc_k$ = function () {
    return this.id_1;
  };
  protoOf(DocEntry).component2_7eebsb_k$ = function () {
    return this.type_1;
  };
  protoOf(DocEntry).component3_7eebsa_k$ = function () {
    return this.title_1;
  };
  protoOf(DocEntry).component4_7eebs9_k$ = function () {
    return this.typeLabel_1;
  };
  protoOf(DocEntry).component5_7eebs8_k$ = function () {
    return this.description_1;
  };
  protoOf(DocEntry).component6_7eebs7_k$ = function () {
    return this.syntaxCode_1;
  };
  protoOf(DocEntry).component7_7eebs6_k$ = function () {
    return this.exampleCode_1;
  };
  protoOf(DocEntry).copy_ytms63_k$ = function (id, type, title, typeLabel, description, syntaxCode, exampleCode) {
    return new DocEntry(id, type, title, typeLabel, description, syntaxCode, exampleCode);
  };
  protoOf(DocEntry).copy$default_892bkr_k$ = function (id, type, title, typeLabel, description, syntaxCode, exampleCode, $super) {
    id = id === VOID ? this.id_1 : id;
    type = type === VOID ? this.type_1 : type;
    title = title === VOID ? this.title_1 : title;
    typeLabel = typeLabel === VOID ? this.typeLabel_1 : typeLabel;
    description = description === VOID ? this.description_1 : description;
    syntaxCode = syntaxCode === VOID ? this.syntaxCode_1 : syntaxCode;
    exampleCode = exampleCode === VOID ? this.exampleCode_1 : exampleCode;
    return $super === VOID ? this.copy_ytms63_k$(id, type, title, typeLabel, description, syntaxCode, exampleCode) : $super.copy_ytms63_k$.call(this, id, type, title, typeLabel, description, syntaxCode, exampleCode);
  };
  protoOf(DocEntry).toString = function () {
    return 'DocEntry(id=' + this.id_1 + ', type=' + this.type_1 + ', title=' + this.title_1 + ', typeLabel=' + this.typeLabel_1 + ', description=' + this.description_1 + ', syntaxCode=' + this.syntaxCode_1 + ', exampleCode=' + this.exampleCode_1 + ')';
  };
  protoOf(DocEntry).hashCode = function () {
    ...
    result = imul(result, 31) + getStringHashCode(this.typeLabel_1) | 0;
    result = imul(result, 31) + getStringHashCode(this.description_1) | 0;
    result = imul(result, 31) + getStringHashCode(this.syntaxCode_1) | 0;
    result = imul(result, 31) + getStringHashCode(this.exampleCode_1) | 0;
    return result;
  };
  protoOf(DocEntry).equals = function (other) {
    ...
    if (!(this.title_1 === other.title_1))
      return false;
    if (!(this.typeLabel_1 === other.typeLabel_1))
      return false;
    if (!(this.description_1 === other.description_1))
      return false;
    if (!(this.syntaxCode_1 === other.syntaxCode_1))
      return false;
    if (!(this.exampleCode_1 === other.exampleCode_1))
      return false;
    return true;
  };
  function AddonSummary(id, title, description, downloadUrl) {
    ...
    this.title_1 = title;
    this.description_1 = description;
    this.downloadUrl_1 = downloadUrl;
  }
  protoOf(AddonSummary).get_id_kntnx8_k$ = function () {
    return this.id_1;
  };
  protoOf(AddonSummary).get_title_iz32un_k$ = function () {
    return this.title_1;
  };
  protoOf(AddonSummary).get_description_emjre5_k$ = function () {
    return this.description_1;
  };
  protoOf(AddonSummary).get_downloadUrl_64vv6q_k$ = function () {
    return this.downloadUrl_1;
  };
  protoOf(AddonSummary).component1_7eebsc_k$ = function () {
    return this.id_1;
  };
  protoOf(AddonSummary).component2_7eebsb_k$ = function () {
    return this.title_1;
  };
  protoOf(AddonSummary).component3_7eebsa_k$ = function () {
    return this.description_1;
  };
  protoOf(AddonSummary).component4_7eebs9_k$ = function () {
    return this.downloadUrl_1;
  };
  protoOf(AddonSummary).copy_hmmiyd_k$ = function (id, title, description, downloadUrl) {
    return new AddonSummary(id, title, description, downloadUrl);
  };
  protoOf(AddonSummary).copy$default_dxj1q0_k$ = function (id, title, description, downloadUrl, $super) {
    id = id === VOID ? this.id_1 : id;
    title = title === VOID ? this.title_1 : title;
    description = description === VOID ? this.description_1 : description;
    downloadUrl = downloadUrl === VOID ? this.downloadUrl_1 : downloadUrl;
    return $super === VOID ? this.copy_hmmiyd_k$(id, title, description, downloadUrl) : $super.copy_hmmiyd_k$.call(this, id, title, description, downloadUrl);
  };
  protoOf(AddonSummary).toString = function () {
    return 'AddonSummary(id=' + this.id_1 + ', title=' + this.title_1 + ', description=' + this.description_1 + ', downloadUrl=' + this.downloadUrl_1 + ')';
  };
  protoOf(AddonSummary).hashCode = function () {
    var result = getStringHashCode(this.id_1);
    result = imul(result, 31) + getStringHashCode(this.title_1) | 0;
    result = imul(result, 31) + getStringHashCode(this.description_1) | 0;
    result = imul(result, 31) + getStringHashCode(this.downloadUrl_1) | 0;
    return result;
  };
  protoOf(AddonSummary).equals = function (other) {
    ...
    if (!(this.description_1 === other.description_1))
      return false;
    if (!(this.downloadUrl_1 === other.downloadUrl_1))
      return false;
    return true;
  };
  function AddonDetail(id, title, description, repositoryUrl, downloadUrl, versions, dependencies) {
    ...
    this.title_1 = title;
    this.description_1 = description;
    this.repositoryUrl_1 = repositoryUrl;
    this.downloadUrl_1 = downloadUrl;
    this.versions_1 = versions;
    this.dependencies_1 = dependencies;
  }
  protoOf(AddonDetail).get_id_kntnx8_k$ = function () {
    return this.id_1;
  };
  protoOf(AddonDetail).get_title_iz32un_k$ = function () {
    return this.title_1;
  };
  protoOf(AddonDetail).get_description_emjre5_k$ = function () {
    return this.description_1;
  };
  protoOf(AddonDetail).get_repositoryUrl_h05ti4_k$ = function () {
    return this.repositoryUrl_1;
  };
  protoOf(AddonDetail).get_downloadUrl_64vv6q_k$ = function () {
    return this.downloadUrl_1;
  };
  protoOf(AddonDetail).get_versions_6ebqlg_k$ = function () {
    return this.versions_1;
  };
  protoOf(AddonDetail).get_dependencies_cvhxma_k$ = function () {
    return this.dependencies_1;
  };
  protoOf(AddonDetail).component1_7eebsc_k$ = function () {
    return this.id_1;
  };
  protoOf(AddonDetail).component2_7eebsb_k$ = function () {
    return this.title_1;
  };
  protoOf(AddonDetail).component3_7eebsa_k$ = function () {
    return this.description_1;
  };
  protoOf(AddonDetail).component4_7eebs9_k$ = function () {
    return this.repositoryUrl_1;
  };
  protoOf(AddonDetail).component5_7eebs8_k$ = function () {
    return this.downloadUrl_1;
  };
  protoOf(AddonDetail).component6_7eebs7_k$ = function () {
    return this.versions_1;
  };
  protoOf(AddonDetail).component7_7eebs6_k$ = function () {
    return this.dependencies_1;
  };
  protoOf(AddonDetail).copy_nlrn4x_k$ = function (id, title, description, repositoryUrl, downloadUrl, versions, dependencies) {
    return new AddonDetail(id, title, description, repositoryUrl, downloadUrl, versions, dependencies);
  };
  protoOf(AddonDetail).copy$default_ytq8xu_k$ = function (id, title, description, repositoryUrl, downloadUrl, versions, dependencies, $super) {
    id = id === VOID ? this.id_1 : id;
    title = title === VOID ? this.title_1 : title;
    description = description === VOID ? this.description_1 : description;
    repositoryUrl = repositoryUrl === VOID ? this.repositoryUrl_1 : repositoryUrl;
    downloadUrl = downloadUrl === VOID ? this.downloadUrl_1 : downloadUrl;
    versions = versions === VOID ? this.versions_1 : versions;
    dependencies = dependencies === VOID ? this.dependencies_1 : dependencies;
    return $super === VOID ? this.copy_nlrn4x_k$(id, title, description, repositoryUrl, downloadUrl, versions, dependencies) : $super.copy_nlrn4x_k$.call(this, id, title, description, repositoryUrl, downloadUrl, versions, dependencies);
  };
  protoOf(AddonDetail).toString = function () {
    return 'AddonDetail(id=' + this.id_1 + ', title=' + this.title_1 + ', description=' + this.description_1 + ', repositoryUrl=' + this.repositoryUrl_1 + ', downloadUrl=' + this.downloadUrl_1 + ', versions=' + toString(this.versions_1) + ', dependencies=' + toString(this.dependencies_1) + ')';
  };
  protoOf(AddonDetail).hashCode = function () {
    var result = getStringHashCode(this.id_1);
    result = imul(result, 31) + getStringHashCode(this.title_1) | 0;
    result = imul(result, 31) + getStringHashCode(this.description_1) | 0;
    result = imul(result, 31) + getStringHashCode(this.repositoryUrl_1) | 0;
    result = imul(result, 31) + getStringHashCode(this.downloadUrl_1) | 0;
    result = imul(result, 31) + hashCode(this.versions_1) | 0;
  ...
  protoOf(AddonDetail).equals = function (other) {
    ...
    if (!(this.description_1 === other.description_1))
      return false;
    if (!(this.repositoryUrl_1 === other.repositoryUrl_1))
      return false;
    if (!(this.downloadUrl_1 === other.downloadUrl_1))
      return false;
    if (!equals(this.versions_1, other.versions_1))
      return false;
  ...
  protoOf(ScriptSnippet).get_id_kntnx8_k$ = function () {
    return this.id_1;
  };
  protoOf(ScriptSnippet).get_title_iz32un_k$ = function () {
    return this.title_1;
  };
  protoOf(ScriptSnippet).get_description_emjre5_k$ = function () {
    return this.description_1;
  };
  protoOf(ScriptSnippet).get_code_wok7xy_k$ = function () {
    return this.code_1;
  };
  protoOf(ScriptSnippet).component1_7eebsc_k$ = function () {
    return this.id_1;
  };
  protoOf(ScriptSnippet).component2_7eebsb_k$ = function () {
    return this.title_1;
  };
  protoOf(ScriptSnippet).component3_7eebsa_k$ = function () {
    return this.description_1;
  };
  protoOf(ScriptSnippet).component4_7eebs9_k$ = function () {
    return this.code_1;
  };
  protoOf(ScriptSnippet).copy_hmmiyd_k$ = function (id, title, description, code) {
    return new ScriptSnippet(id, title, description, code);
  };
  protoOf(ScriptSnippet).copy$default_oej9rc_k$ = function (id, title, description, code, $super) {
    id = id === VOID ? this.id_1 : id;
    title = title === VOID ? this.title_1 : title;
    description = description === VOID ? this.description_1 : description;
    code = code === VOID ? this.code_1 : code;
    return $super === VOID ? this.copy_hmmiyd_k$(id, title, description, code) : $super.copy_hmmiyd_k$.call(this, id, title, description, code);
  };
  protoOf(ScriptSnippet).toString = function () {
    return 'ScriptSnippet(id=' + this.id_1 + ', title=' + this.title_1 + ', description=' + this.description_1 + ', code=' + this.code_1 + ')';
  };
  ...
  function org_example_app_data_DocEntry$stableprop_getter() {
    return org_example_app_data_DocEntry$stable;
  }
  function org_example_app_data_AddonSummary$stableprop_getter() {
    return org_example_app_data_AddonSummary$stable;
  }
  function org_example_app_data_AddonDetail$stableprop_getter() {
    return org_example_app_data_AddonDetail$stable;
  }
  function org_example_app_data_ScriptSnippet$stableprop_getter() {
    return org_example_app_data_ScriptSnippet$stable;
  }
  ...
  function HomePage($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-986398271);
    if ($composer_0.shouldExecute_4fplh_k$(!($changed === 0), $changed & 1)) {
      SiteScaffold('home', null, ComposableSingletons$IndexKt_getInstance().lambda$1338523861__1, $composer_0, 390, 2);
    } else {
      $composer_0.skipToGroupEnd_lh3zi2_k$();
    }
    var tmp0_safe_receiver = $composer_0.endRestartGroup_yxpjv9_k$();
  ...
  function ComposableSingletons$IndexKt$lambda$233498298$lambda($this$Div, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$681318329__1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_0 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_1;
    ...
    var tmp_2 = tmp_1;
    var tmp$ret$7 = (tmp_2 == null ? true : !(tmp_2 == null)) ? tmp_2 : THROW_CCE();
    Div(tmp$ret$7, ComposableSingletons$IndexKt_getInstance().lambda$750002160__1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    ...
    var tmp_4 = tmp_3;
    var tmp$ret$11 = (tmp_4 == null ? true : !(tmp_4 == null)) ? tmp_4 : THROW_CCE();
    Div(tmp$ret$11, ComposableSingletons$IndexKt_getInstance().lambda$_481290383_zei8rm_1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_2 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_5;
    ...
    var tmp_6 = tmp_5;
    var tmp$ret$15 = (tmp_6 == null ? true : !(tmp_6 == null)) ? tmp_6 : THROW_CCE();
    Div(tmp$ret$15, ComposableSingletons$IndexKt_getInstance().lambda$_1712582926_14s5q3__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  function ComposableSingletons$IndexKt$lambda$233498298$lambda$lambda($this$Div) {
    $this$Div.classes_ayghm2_k$(['panel', 'placeholder-block', 'placeholder-block-large', 'fade-in']);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$241788923$lambda($this$Section, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$233498298__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$1645619366$lambda($this$Div, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    A('/addons/', tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$1497102356__1, $composer_0, 438, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$166067824$lambda($this$Div, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$_1932132881_58oqbs_1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_0 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_1;
    ...
    var tmp_2 = tmp_1;
    var tmp$ret$7 = (tmp_2 == null ? true : !(tmp_2 == null)) ? tmp_2 : THROW_CCE();
    H2(tmp$ret$7, ComposableSingletons$IndexKt_getInstance().lambda$_1613185650_thijgm_1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_1 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_3;
    ...
    var tmp_4 = tmp_3;
    var tmp$ret$11 = (tmp_4 == null ? true : !(tmp_4 == null)) ? tmp_4 : THROW_CCE();
    P(tmp$ret$11, ComposableSingletons$IndexKt_getInstance().lambda$_2018898930_a8q05w_1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_2 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_5;
    ...
    var tmp_6 = tmp_5;
    var tmp$ret$15 = (tmp_6 == null ? true : !(tmp_6 == null)) ? tmp_6 : THROW_CCE();
    Div(tmp$ret$15, ComposableSingletons$IndexKt_getInstance().lambda$1645619366__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  function ComposableSingletons$IndexKt$lambda$166067824$lambda$lambda($this$Div) {
    $this$Div.classes_ayghm2_k$(['kicker']);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$166067824$lambda$lambda_1($this$P) {
    $this$P.classes_ayghm2_k$(['helper']);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$_692252367$lambda_4y5xnj($this$Div, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$166067824__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$_1314896334$lambda_2b8cht($this$Section, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$_692252367_j25210__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$1818033447$lambda($this$Div, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    A('/docs/', tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$1669516437__1, $composer_0, 438, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$338481905$lambda($this$Div, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$_1759718800_4ni1x0__1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_0 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_1;
    ...
    var tmp_2 = tmp_1;
    var tmp$ret$7 = (tmp_2 == null ? true : !(tmp_2 == null)) ? tmp_2 : THROW_CCE();
    H2(tmp$ret$7, ComposableSingletons$IndexKt_getInstance().lambda$_1440771569_4ixdrq_1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_1 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_3;
    ...
    var tmp_4 = tmp_3;
    var tmp$ret$11 = (tmp_4 == null ? true : !(tmp_4 == null)) ? tmp_4 : THROW_CCE();
    P(tmp$ret$11, ComposableSingletons$IndexKt_getInstance().lambda$_1846484849_sdo3i2__1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_2 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_5;
    ...
    var tmp_6 = tmp_5;
    var tmp$ret$15 = (tmp_6 == null ? true : !(tmp_6 == null)) ? tmp_6 : THROW_CCE();
    Div(tmp$ret$15, ComposableSingletons$IndexKt_getInstance().lambda$1818033447__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$_519838286$lambda_qlrzz7($this$Div, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$338481905__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$_1142482253$lambda_etlhk3($this$Section, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$_519838286_51kpq8__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$1990447528$lambda($this$Div, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    A('/scripts/', tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$1841930518__1, $composer_0, 438, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$510895986$lambda($this$Div, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$_1587304719_mf80jp_1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_0 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_1;
    ...
    var tmp_2 = tmp_1;
    var tmp$ret$7 = (tmp_2 == null ? true : !(tmp_2 == null)) ? tmp_2 : THROW_CCE();
    H2(tmp$ret$7, ComposableSingletons$IndexKt_getInstance().lambda$_1268357488_od27si_1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_1 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_3;
    ...
    var tmp_4 = tmp_3;
    var tmp$ret$11 = (tmp_4 == null ? true : !(tmp_4 == null)) ? tmp_4 : THROW_CCE();
    P(tmp$ret$11, ComposableSingletons$IndexKt_getInstance().lambda$_1674070768_fkpw0y_1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_2 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_5;
    ...
    var tmp_6 = tmp_5;
    var tmp$ret$15 = (tmp_6 == null ? true : !(tmp_6 == null)) ? tmp_6 : THROW_CCE();
    Div(tmp$ret$15, ComposableSingletons$IndexKt_getInstance().lambda$1990447528__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$_347424205$lambda_fqu6qs($this$Div, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$510895986__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$_970068172$lambda_wcfmt5($this$Section, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$_347424205_w4aro9__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$_2027002328$lambda_q8s0x3($this$Main, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Section(tmp$ret$3, ComposableSingletons$IndexKt_getInstance().lambda$241788923__1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_0 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_1;
    ...
    var tmp_2 = tmp_1;
    var tmp$ret$7 = (tmp_2 == null ? true : !(tmp_2 == null)) ? tmp_2 : THROW_CCE();
    Section(tmp$ret$7, ComposableSingletons$IndexKt_getInstance().lambda$_1314896334_75zh84__1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_1 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_3;
    ...
    var tmp_4 = tmp_3;
    var tmp$ret$11 = (tmp_4 == null ? true : !(tmp_4 == null)) ? tmp_4 : THROW_CCE();
    Section(tmp$ret$11, ComposableSingletons$IndexKt_getInstance().lambda$_1142482253_jwql80__1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_2 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_5;
    ...
    var tmp_6 = tmp_5;
    var tmp$ret$15 = (tmp_6 == null ? true : !(tmp_6 == null)) ? tmp_6 : THROW_CCE();
    Section(tmp$ret$15, ComposableSingletons$IndexKt_getInstance().lambda$_970068172_ghg2p0__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$1338523861$lambda($composer, $changed) {
    var $composer_0 = $composer;
    if ($composer_0.shouldExecute_4fplh_k$(!(($changed & 3) === 2), $changed & 1)) {
      Main(null, ComposableSingletons$IndexKt_getInstance().lambda$_2027002328_kgj44a_1, $composer_0, 48, 1);
    } else {
      $composer_0.skipToGroupEnd_lh3zi2_k$();
    }
    return Unit_getInstance();
  ...
  protoOf(ComposableSingletons$IndexKt).get_lambda$750002160_cimnhe_k$ = function () {
    return this.lambda$750002160__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_481290383_ic49ng_k$ = function () {
    return this.lambda$_481290383_zei8rm_1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_1712582926_en479j_k$ = function () {
    return this.lambda$_1712582926_14s5q3__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$233498298_cx2pvd_k$ = function () {
    return this.lambda$233498298__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$241788923_y5xk9_k$ = function () {
    return this.lambda$241788923__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_1932132881_6yzahg_k$ = function () {
    return this.lambda$_1932132881_58oqbs_1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_1613185650_h682ky_k$ = function () {
    return this.lambda$_1613185650_thijgm_1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_2018898930_n0mn20_k$ = function () {
    return this.lambda$_2018898930_a8q05w_1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$1497102356_nqmhoh_k$ = function () {
    return this.lambda$1497102356__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$1645619366_o1nt1i_k$ = function () {
    return this.lambda$1645619366__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$166067824_jwwxu7_k$ = function () {
    return this.lambda$166067824__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_692252367_28ptx6_k$ = function () {
    return this.lambda$_692252367_j25210__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_1314896334_r7057s_k$ = function () {
    return this.lambda$_1314896334_75zh84__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_1759718800_m5h76w_k$ = function () {
    return this.lambda$_1759718800_4ni1x0__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_1440771569_6f3qwa_k$ = function () {
    return this.lambda$_1440771569_4ixdrq_1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_1846484849_i8ra9y_k$ = function () {
    return this.lambda$_1846484849_sdo3i2__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$1669516437_94uorp_k$ = function () {
    return this.lambda$1669516437__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$1818033447_miv630_k$ = function () {
    return this.lambda$1818033447__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$338481905_ul7bkw_k$ = function () {
    return this.lambda$338481905__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_519838286_ppj62m_k$ = function () {
    return this.lambda$_519838286_51kpq8__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_1142482253_t8c3uk_k$ = function () {
    return this.lambda$_1142482253_jwql80__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_1587304719_d380lt_k$ = function () {
    return this.lambda$_1587304719_mf80jp_1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_1268357488_5un76i_k$ = function () {
    return this.lambda$_1268357488_od27si_1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_1674070768_3mzhd6_k$ = function () {
    return this.lambda$_1674070768_fkpw0y_1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$1841930518_lelmuh_k$ = function () {
    return this.lambda$1841930518__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$1990447528_f6m9su_k$ = function () {
    return this.lambda$1990447528__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$510895986_4t475e_k$ = function () {
    return this.lambda$510895986__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_347424205_sjkyon_k$ = function () {
    return this.lambda$_347424205_w4aro9__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_970068172_hefjtq_k$ = function () {
    return this.lambda$_970068172_ghg2p0__1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$_2027002328_l7g0pa_k$ = function () {
    return this.lambda$_2027002328_kgj44a_1;
  };
  protoOf(ComposableSingletons$IndexKt).get_lambda$1338523861_658lvh_k$ = function () {
    return this.lambda$1338523861__1;
  };
  ...
  function NotFoundPage($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(200536444);
    if ($composer_0.shouldExecute_4fplh_k$(!($changed === 0), $changed & 1)) {
      SiteScaffold('', null, ComposableSingletons$NotFoundKt_getInstance().lambda$_656731160_z6nv0j_1, $composer_0, 390, 2);
    } else {
      $composer_0.skipToGroupEnd_lh3zi2_k$();
    }
    var tmp0_safe_receiver = $composer_0.endRestartGroup_yxpjv9_k$();
  ...
  function ComposableSingletons$NotFoundKt$lambda$_1128893308$lambda_9pd8a9($this$Div, $composer, $changed) {
    var $composer_0 = $composer;
    H1(null, ComposableSingletons$NotFoundKt_getInstance().lambda$1615325319__1, $composer_0, 48, 1);
  ...
  function ComposableSingletons$NotFoundKt$lambda$1590817379$lambda($this$Div, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$NotFoundKt_getInstance().lambda$_1128893308_cf53rz_1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  function ComposableSingletons$NotFoundKt$lambda$1590817379$lambda$lambda($this$Div) {
    $this$Div.classes_ayghm2_k$(['panel', 'fade-in']);
    $this$Div.style_xwwy6r_k$(ComposableSingletons$NotFoundKt$lambda$1590817379$lambda$lambda$lambda);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$NotFoundKt$lambda$1281144322$lambda($this$Section, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$NotFoundKt_getInstance().lambda$1590817379__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$NotFoundKt$lambda$_600646859$lambda_2a25su($this$Main, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Section(tmp$ret$3, ComposableSingletons$NotFoundKt_getInstance().lambda$1281144322__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$NotFoundKt$lambda$_656731160$lambda_muzyiz($composer, $changed) {
    var $composer_0 = $composer;
    if ($composer_0.shouldExecute_4fplh_k$(!(($changed & 3) === 2), $changed & 1)) {
      Main(null, ComposableSingletons$NotFoundKt_getInstance().lambda$_600646859_gavsju_1, $composer_0, 48, 1);
    } else {
      $composer_0.skipToGroupEnd_lh3zi2_k$();
    }
    return Unit_getInstance();
  ...
  protoOf(ComposableSingletons$NotFoundKt).get_lambda$1980774822_y0177h_k$ = function () {
    return this.lambda$1980774822__1;
  };
  protoOf(ComposableSingletons$NotFoundKt).get_lambda$_1128893308_ani771_k$ = function () {
    return this.lambda$_1128893308_cf53rz_1;
  };
  protoOf(ComposableSingletons$NotFoundKt).get_lambda$1590817379_no4ogf_k$ = function () {
    return this.lambda$1590817379__1;
  };
  protoOf(ComposableSingletons$NotFoundKt).get_lambda$1281144322_32bm9x_k$ = function () {
    return this.lambda$1281144322__1;
  };
  protoOf(ComposableSingletons$NotFoundKt).get_lambda$_600646859_eprogc_k$ = function () {
    return this.lambda$_600646859_gavsju_1;
  };
  protoOf(ComposableSingletons$NotFoundKt).get_lambda$_656731160_tkrygx_k$ = function () {
    return this.lambda$_656731160_z6nv0j_1;
  };
  ...
  function Addon0001Page($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-819675943);
    if ($composer_0.shouldExecute_4fplh_k$(!($changed === 0), $changed & 1)) {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.updateScope_t8jcf_k$(Addon0001Page$lambda($changed));
    }
  }
  ...
  function Addon0002Page($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(1667473623);
    if ($composer_0.shouldExecute_4fplh_k$(!($changed === 0), $changed & 1)) {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.updateScope_t8jcf_k$(Addon0002Page$lambda($changed));
    }
  }
  ...
  function Addon0003Page($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-140344107);
    if ($composer_0.shouldExecute_4fplh_k$(!($changed === 0), $changed & 1)) {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.updateScope_t8jcf_k$(Addon0003Page$lambda($changed));
    }
  }
  ...
  function AddonDetailPage(addon, $composer, $changed) {
    ...
    var $dirty = $changed;
    if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.changedInstance_s1wkiy_k$(addon) ? 4 : 2);
    if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 3) === 2), $dirty & 1)) {
      // Inline function 'kotlin.run' call
  ...
  protoOf(ComposableSingletons$AddonDetailPageKt).get_lambda$381565458_j5e0me_k$ = function () {
    return this.lambda$381565458__1;
  };
  protoOf(ComposableSingletons$AddonDetailPageKt).get_lambda$110375867_mi5pqp_k$ = function () {
    return this.lambda$110375867__1;
  };
  protoOf(ComposableSingletons$AddonDetailPageKt).get_lambda$_594484454_tcdov9_k$ = function () {
    return this.lambda$_594484454_89pijn_1;
  };
  protoOf(ComposableSingletons$AddonDetailPageKt).get_lambda$762536613_6axr0q_k$ = function () {
    return this.lambda$762536613__1;
  };
  protoOf(ComposableSingletons$AddonDetailPageKt).get_lambda$1266727438_trn0ot_k$ = function () {
    return this.lambda$1266727438__1;
  };
  protoOf(ComposableSingletons$AddonDetailPageKt).get_lambda$_655615090_4toj91_k$ = function () {
    return this.lambda$_655615090_knz8fn_1;
  };
  ...
  function AddonDetailPage$lambda$lambda($this$Main) {
    $this$Main.classes_ayghm2_k$(['page']);
    return Unit_getInstance();
  }
  function AddonDetailPage$lambda$lambda$lambda($this$Section) {
    $this$Section.classes_ayghm2_k$(['container', 'addon-detail-shell']);
    return Unit_getInstance();
  }
  function AddonDetailPage$lambda$lambda$lambda$lambda($this$Div) {
    $this$Div.classes_ayghm2_k$(['panel', 'addon-detail-header', 'fade-in']);
    return Unit_getInstance();
  }
  ...
  function AddonDetailPage$lambda$lambda$lambda$lambda$lambda_1($addon) {
    return function ($this$H1, $composer, $changed) {
      var $composer_0 = $composer;
      Text($addon.get_title_iz32un_k$(), $composer_0, 0);
      return Unit_getInstance();
    };
  }
  ...
  function AddonDetailPage$lambda$lambda$lambda$lambda$lambda_3($addon) {
    return function ($this$P, $composer, $changed) {
      var $composer_0 = $composer;
      Text($addon.get_description_emjre5_k$(), $composer_0, 0);
      return Unit_getInstance();
    };
  }
  ...
  function AddonDetailPage$lambda$lambda$lambda$lambda$lambda_5($addon) {
    return function ($this$Div, $composer, $changed) {
      ...
      var tmp_0 = tmp;
      var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
      A('/addons/', tmp$ret$3, ComposableSingletons$AddonDetailPageKt_getInstance().lambda$381565458__1, $composer_0, 438, 0);
      var tmp_1 = $addon.get_repositoryUrl_h05ti4_k$();
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      var it_0 = $composer_0.rememberedValue_4dg93v_k$();
      var tmp_2;
      ...
      var tmp_3 = tmp_2;
      var tmp$ret$7 = (tmp_3 == null ? true : !(tmp_3 == null)) ? tmp_3 : THROW_CCE();
      A(tmp_1, tmp$ret$7, ComposableSingletons$AddonDetailPageKt_getInstance().lambda$110375867__1, $composer_0, 432, 0);
      var tmp_4 = $addon.get_downloadUrl_64vv6q_k$();
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      var it_1 = $composer_0.rememberedValue_4dg93v_k$();
      var tmp_5;
      ...
      A(tmp_4, tmp$ret$11, ComposableSingletons$AddonDetailPageKt_getInstance().lambda$_594484454_89pijn_1, $composer_0, 432, 0);
      return Unit_getInstance();
    };
  }
  ...
  function AddonDetailPage$lambda$lambda$lambda$lambda_0($addon) {
    return function ($this$Div, $composer, $changed) {
      ...
      var tmp_0 = tmp;
      var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
      Div(tmp$ret$3, ComposableSingletons$AddonDetailPageKt_getInstance().lambda$921614039__1, $composer_0, 54, 0);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      var it_0 = $composer_0.rememberedValue_4dg93v_k$();
      var tmp_1;
  ...
  function AddonDetailPage$lambda$lambda$lambda$lambda_1($this$Section) {
    $this$Section.classes_ayghm2_k$(['addon-meta-grid']);
    return Unit_getInstance();
  }
  function AddonDetailPage$lambda$lambda$lambda$lambda$lambda_6($this$Div) {
    $this$Div.classes_ayghm2_k$(['panel', 'addon-meta-card', 'fade-in']);
    return Unit_getInstance();
  }
  ...
  function AddonDetailPage$lambda$lambda$lambda$lambda$lambda$lambda_3($this$Ul) {
    $this$Ul.classes_ayghm2_k$(['addon-list']);
    return Unit_getInstance();
  }
  ...
  function AddonDetailPage$lambda$lambda$lambda$lambda$lambda$lambda_4($addon) {
    return function ($this$Ul, $composer, $changed) {
      ...
      var _iterator__ex2g4s = $addon.get_versions_6ebqlg_k$().iterator_jk1svi_k$();
      while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
        var element = _iterator__ex2g4s.next_20eer_k$();
        // Inline function 'kotlin.run' call
  ...
  function AddonDetailPage$lambda$lambda$lambda$lambda$lambda_7($addon) {
    return function ($this$Div, $composer, $changed) {
      ...
      var tmp_0 = tmp;
      var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
      H2(tmp$ret$3, ComposableSingletons$AddonDetailPageKt_getInstance().lambda$762536613__1, $composer_0, 54, 0);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      var it_0 = $composer_0.rememberedValue_4dg93v_k$();
      var tmp_1;
  ...
  function AddonDetailPage$lambda$lambda$lambda$lambda$lambda$lambda_8($addon) {
    return function ($this$Ul, $composer, $changed) {
      var $composer_0 = $composer;
      // Inline function 'kotlin.collections.forEach' call
      var _iterator__ex2g4s = $addon.get_dependencies_cvhxma_k$().iterator_jk1svi_k$();
      while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
        var element = _iterator__ex2g4s.next_20eer_k$();
        // Inline function 'kotlin.run' call
  ...
  function AddonDetailPage$lambda$lambda$lambda$lambda$lambda_9($addon) {
    return function ($this$Div, $composer, $changed) {
      ...
      var tmp_0 = tmp;
      var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
      H2(tmp$ret$3, ComposableSingletons$AddonDetailPageKt_getInstance().lambda$1266727438__1, $composer_0, 54, 0);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      var it_0 = $composer_0.rememberedValue_4dg93v_k$();
      var tmp_1;
      ...
      var tmp_2 = tmp_1;
      var tmp$ret$7 = (tmp_2 == null ? true : !(tmp_2 == null)) ? tmp_2 : THROW_CCE();
      P(tmp$ret$7, ComposableSingletons$AddonDetailPageKt_getInstance().lambda$_655615090_knz8fn_1, $composer_0, 54, 0);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      var it_1 = $composer_0.rememberedValue_4dg93v_k$();
      var tmp_3;
  ...
  function AddonsPage($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(1600189146);
    if ($composer_0.shouldExecute_4fplh_k$(!($changed === 0), $changed & 1)) {
      SiteScaffold('addons', 'Community Addons', ComposableSingletons$IndexKt_getInstance_0().lambda$_1895224762_szjwk2__1, $composer_0, 438, 0);
    } else {
      $composer_0.skipToGroupEnd_lh3zi2_k$();
    }
    var tmp0_safe_receiver = $composer_0.endRestartGroup_yxpjv9_k$();
  ...
  function ComposableSingletons$IndexKt$lambda$_80001796$lambda_7nveyg($this$Article, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$IndexKt_getInstance_0().lambda$434367069__1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_0 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_1;
    ...
    var tmp_2 = tmp_1;
    var tmp$ret$7 = (tmp_2 == null ? true : !(tmp_2 == null)) ? tmp_2 : THROW_CCE();
    H1(tmp$ret$7, ComposableSingletons$IndexKt_getInstance_0().lambda$_843370113_rlh2oi_1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$822721965$lambda($this$Section, $composer, $changed) {
    var $composer_0 = $composer;
    // Inline function 'kotlin.collections.forEach' call
    var _iterator__ex2g4s = get_addonSummaries().iterator_jk1svi_k$();
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      var element = _iterator__ex2g4s.next_20eer_k$();
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
  ...
  function ComposableSingletons$IndexKt$lambda$822721965$lambda$lambda($this$Article) {
    $this$Article.classes_ayghm2_k$(['panel', 'addon-result-card', 'fade-in']);
    return Unit_getInstance();
  }
  function ComposableSingletons$IndexKt$lambda$822721965$lambda$lambda$lambda($this$H2) {
    $this$H2.classes_ayghm2_k$(['card-title']);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$822721965$lambda$lambda$lambda_4($addon) {
    return function ($this$Div, $composer, $changed) {
      var $composer_0 = $composer;
      var tmp = '/addons/' + $addon.get_id_kntnx8_k$();
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      var it = $composer_0.rememberedValue_4dg93v_k$();
      var tmp_0;
      ...
      var tmp_1 = tmp_0;
      var tmp$ret$3 = (tmp_1 == null ? true : !(tmp_1 == null)) ? tmp_1 : THROW_CCE();
      A(tmp, tmp$ret$3, ComposableSingletons$IndexKt_getInstance_0().lambda$2145552729__1, $composer_0, 432, 0);
      var tmp_2 = $addon.get_downloadUrl_64vv6q_k$();
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      var it_0 = $composer_0.rememberedValue_4dg93v_k$();
      var tmp_3;
      ...
      A(tmp_2, tmp$ret$7, ComposableSingletons$IndexKt_getInstance_0().lambda$_1605550832_r3whrz_1, $composer_0, 432, 0);
      return Unit_getInstance();
    };
  }
  ...
  function ComposableSingletons$IndexKt$lambda$682274272$lambda($this$Section, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Article(tmp$ret$3, ComposableSingletons$IndexKt_getInstance_0().lambda$_80001796_z5ybt7__1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_0 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_1;
    ...
    var tmp_2 = tmp_1;
    var tmp$ret$7 = (tmp_2 == null ? true : !(tmp_2 == null)) ? tmp_2 : THROW_CCE();
    Section(tmp$ret$7, ComposableSingletons$IndexKt_getInstance_0().lambda$822721965__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  function ComposableSingletons$IndexKt$lambda$682274272$lambda$lambda($this$Article) {
    $this$Article.classes_ayghm2_k$(['panel', 'addons-header']);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$462180947$lambda($this$Main, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Section(tmp$ret$3, ComposableSingletons$IndexKt_getInstance_0().lambda$682274272__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  function ComposableSingletons$IndexKt$lambda$_1895224762$lambda_b6edgf($composer, $changed) {
    ...
    if ($composer_0.shouldExecute_4fplh_k$(!(($changed & 3) === 2), $changed & 1)) {
      ...
      var tmp_0 = tmp;
      var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
      Main(tmp$ret$3, ComposableSingletons$IndexKt_getInstance_0().lambda$462180947__1, $composer_0, 54, 0);
    } else {
      $composer_0.skipToGroupEnd_lh3zi2_k$();
    }
    return Unit_getInstance();
  ...
  protoOf(ComposableSingletons$IndexKt_0).get_lambda$_843370113_bic5g0_k$ = function () {
    return this.lambda$_843370113_rlh2oi_1;
  };
  protoOf(ComposableSingletons$IndexKt_0).get_lambda$_80001796_fnf3z_k$ = function () {
    return this.lambda$_80001796_z5ybt7__1;
  };
  protoOf(ComposableSingletons$IndexKt_0).get_lambda$2145552729_v2tu97_k$ = function () {
    return this.lambda$2145552729__1;
  };
  protoOf(ComposableSingletons$IndexKt_0).get_lambda$_1605550832_ikprg5_k$ = function () {
    return this.lambda$_1605550832_r3whrz_1;
  };
  protoOf(ComposableSingletons$IndexKt_0).get_lambda$822721965_9xrlap_k$ = function () {
    return this.lambda$822721965__1;
  };
  protoOf(ComposableSingletons$IndexKt_0).get_lambda$682274272_nt9523_k$ = function () {
    return this.lambda$682274272__1;
  };
  protoOf(ComposableSingletons$IndexKt_0).get_lambda$462180947_ouriii_k$ = function () {
    return this.lambda$462180947__1;
  };
  protoOf(ComposableSingletons$IndexKt_0).get_lambda$_1895224762_34v5vq_k$ = function () {
    return this.lambda$_1895224762_szjwk2__1;
  };
  ...
  function ScriptsPage($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(987103016);
    if ($composer_0.shouldExecute_4fplh_k$(!($changed === 0), $changed & 1)) {
      // Inline function 'androidx.compose.runtime.cache' call
      var this_0 = $composer_0;
      // Inline function 'kotlin.let' call
  ...
  function ComposableSingletons$IndexKt$lambda$1231311050$lambda($this$Article, $composer, $changed) {
    ...
    var tmp_0 = tmp;
    var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
    Div(tmp$ret$3, ComposableSingletons$IndexKt_getInstance_2().lambda$1618551275__1, $composer_0, 54, 0);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    var it_0 = $composer_0.rememberedValue_4dg93v_k$();
    var tmp_1;
    ...
    var tmp_2 = tmp_1;
    var tmp$ret$7 = (tmp_2 == null ? true : !(tmp_2 == null)) ? tmp_2 : THROW_CCE();
    H1(tmp$ret$7, ComposableSingletons$IndexKt_getInstance_2().lambda$2073766029__1, $composer_0, 54, 0);
    return Unit_getInstance();
  }
  ...
  protoOf(ComposableSingletons$IndexKt_2).get_lambda$2073766029_eix347_k$ = function () {
    return this.lambda$2073766029__1;
  };
  protoOf(ComposableSingletons$IndexKt_2).get_lambda$1231311050_wz2a6u_k$ = function () {
    return this.lambda$1231311050__1;
  };
  ...
  function ScriptsPage$lambda($copiedId$delegate) {
    ...
    return $copiedId$delegate.get_value_j01efc_k$();
  }
  function ScriptsPage$lambda_0($copiedId$delegate, _set____db54di) {
    // Inline function 'androidx.compose.runtime.setValue' call
    getLocalDelegateReference('copiedId', KMutableProperty0, true);
    $copiedId$delegate.set_value_v1vabv_k$(_set____db54di);
    return Unit_getInstance();
  }
  ...
  function ScriptsPage$lambda$lambda$lambda$lambda$lambda$lambda_0($snippet) {
    return function ($this$H2, $composer, $changed) {
      var $composer_0 = $composer;
      Text($snippet.get_title_iz32un_k$(), $composer_0, 0);
      return Unit_getInstance();
    };
  }
  ...
  function ScriptsPage$lambda$lambda$lambda$lambda$lambda$lambda_2($snippet) {
    return function ($this$P, $composer, $changed) {
      var $composer_0 = $composer;
      Text($snippet.get_description_emjre5_k$(), $composer_0, 0);
      return Unit_getInstance();
    };
  }
  ...
  function ScriptsPage$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda($snippet, $copiedId$delegate) {
    return function (it) {
      window.navigator.clipboard.writeText($snippet.get_code_wok7xy_k$());
      ScriptsPage$lambda_0($copiedId$delegate, $snippet.get_id_kntnx8_k$());
      var tmp = window;
  ...
  function ScriptsPage$lambda$lambda$lambda$lambda$lambda$lambda$lambda($snippet, $copiedId$delegate) {
    return function ($this$Button) {
      $this$Button.classes_ayghm2_k$(['btn', 'primary']);
      $this$Button.onClick_q9cds6_k$(ScriptsPage$lambda$lambda$lambda$lambda$lambda$lambda$lambda$lambda($snippet, $copiedId$delegate));
      return Unit_getInstance();
    };
  }
  function ScriptsPage$lambda$lambda$lambda$lambda$lambda$lambda$lambda_0($snippet, $copiedId$delegate) {
    return function ($this$Button, $composer, $changed) {
      var $composer_0 = $composer;
      Text(ScriptsPage$lambda($copiedId$delegate) === $snippet.get_id_kntnx8_k$() ? 'Copied' : 'Copy', $composer_0, 0);
      return Unit_getInstance();
    };
  }
  ...
  function ScriptsPage$lambda$lambda$lambda$lambda$lambda$lambda_6($snippet, $copiedId$delegate) {
    return function ($this$Div, $composer, $changed) {
      var $composer_0 = $composer;
      // Inline function 'androidx.compose.runtime.cache' call
      var invalid = $composer_0.changed_ga7h3f_k$($snippet);
      // Inline function 'kotlin.let' call
      var it = $composer_0.rememberedValue_4dg93v_k$();
      var tmp;
      if (invalid || it === Companion_getInstance_0().get_Empty_i9b85g_k$()) {
  ...
  function ScriptsPage$lambda$lambda$lambda$lambda_1($copiedId$delegate) {
    return function ($this$Section, $composer, $changed) {
      var $composer_0 = $composer;
      // Inline function 'kotlin.collections.forEach' call
      var _iterator__ex2g4s = get_scriptSnippets().iterator_jk1svi_k$();
      while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
        var element = _iterator__ex2g4s.next_20eer_k$();
        // Inline function 'androidx.compose.runtime.cache' call
        // Inline function 'kotlin.let' call
  ...
  function ScriptsPage$lambda$lambda$lambda_0($copiedId$delegate) {
    return function ($this$Section, $composer, $changed) {
      ...
      var tmp_0 = tmp;
      var tmp$ret$3 = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
      Article(tmp$ret$3, ComposableSingletons$IndexKt_getInstance_2().lambda$1231311050__1, $composer_0, 54, 0);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      var it_0 = $composer_0.rememberedValue_4dg93v_k$();
      var tmp_1;
